...
import { n as SideNavChildrenMixin, r as sharedStyles } from "./vaadin-side-nav-item-CwuxtUV5.js";
/**
* @license
* Copyright (c) 2023 - 2026 Vaadin Ltd.
* This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
*/
var sideNavStyles = [sharedStyles, css`
  :host {
    white-space: nowrap;
...
`;
//#endregion
//#region node_modules/@vaadin/side-nav/src/vaadin-side-nav.js
/**
* @license
* Copyright (c) 2023 - 2026 Vaadin Ltd.
* This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
...
* @extends HTMLElement
*/
var SideNav = class extends SideNavChildrenMixin(SlotStylesMixin(FocusMixin(ElementMixin(ThemableMixin(PolylitMixin(LumoInjectionMixin(LitElement))))))) {
	static get is() {
	...
	static get properties() {
		return {
			...
			* @type {any}
			*/
			location: { observer: "__locationChanged" },
			/**
	...
	*/
	...
	/** @private */
	_onLabelClick() {
		if (this.collapsible) this.__toggleCollapsed();
	}
	/** @private */
	_onLabelSlotChange() {
