...
//#region node_modules/@vaadin/breadcrumbs/src/styles/vaadin-breadcrumbs-item-base-styles.js
/**
* @license
* Copyright (c) 2026 - 2026 Vaadin Ltd.
* This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
*/
var breadcrumbsItemStyles = css`
  :host {
    display: inline-flex;
...
`;
//#endregion
//#region node_modules/@vaadin/breadcrumbs/src/vaadin-breadcrumbs-item.js
/**
* @license
* Copyright (c) 2026 - 2026 Vaadin Ltd.
* This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
...
* @extends HTMLElement
*/
var BreadcrumbsItem = class extends FocusMixin(DisabledMixin(ElementMixin(PolylitMixin(LumoInjectionMixin(LitElement))))) {
	static get is() {
	...
	*/
	focus(options) {
		if (!this.disabled) super.focus(options);
	}
	/**
...
//# sourceMappingURL=@vaadin_breadcrumbs_src_vaadin-breadcrumbs-item__js.js.map