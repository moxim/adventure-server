...
import { r as get } from "./Fill-D7nksDX_.js";
import { s as ImageStyle } from "./Style-BMeM4QMn.js";
...
var Icon = class Icon extends ImageStyle {
	...
	*/
	constructor(options) {
		...
		*/
		this.iconImage_ = get(image, cacheKey, this.crossOrigin_, imageState, this.color_);
		/**
		* @private
		* @type {Array<number>}
		*/
...
//# sourceMappingURL=Icon-D4n33jqz.js.map