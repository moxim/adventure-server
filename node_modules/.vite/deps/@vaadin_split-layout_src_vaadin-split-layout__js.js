...
//#region node_modules/@vaadin/split-layout/src/styles/vaadin-split-layout-base-styles.js
/**
* @license
...
`;
//#endregion
//#region node_modules/@vaadin/split-layout/src/vaadin-split-layout-mixin.js
/**
* @license
* Copyright (c) 2016 - 2026 Vaadin Ltd.
* This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
...
var SplitLayoutMixin = (superClass) => class SplitLayoutMixin extends superClass {
	...
	_processChildWithSlot(child) {
		...
		} else this[`_${slot}Child`] = child;
	}
	/** @private */
	_processChildWithoutSlot(child, idx) {
		let slotName;
		if (this._primaryChild || this._secondaryChild) slotName = this._primaryChild ? "secondary" : "primary";
		else slotName = idx === 0 ? "primary" : "secondary";
	...
	_onHandleTrack(event) {
		...
		const dirDistance = this.orientation !== "vertical" && this.__isRTL ? -distance : distance;
...
//#endregion
//#region node_modules/@vaadin/split-layout/src/vaadin-split-layout.js
/**
* @license
* Copyright (c) 2016 - 2026 Vaadin Ltd.
* This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
