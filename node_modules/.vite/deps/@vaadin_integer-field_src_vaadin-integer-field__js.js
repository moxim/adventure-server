...
import { t as NumberField } from "./vaadin-number-field-DGWTyoEJ.js";
//#region node_modules/@vaadin/integer-field/src/vaadin-integer-field.js
/**
* @license
	...
	*/
	_stepChanged(step, inputElement) {
		if (step != null && !this.__hasOnlyDigits(step)) {
			console.warn(`<vaadin-integer-field> The \`step\` property must be a positive integer but \`${step}\` was provided, so the property was reset to \`null\`.`);
			this.step = null;
			return;
		}
...
//# sourceMappingURL=@vaadin_integer-field_src_vaadin-integer-field__js.js.map