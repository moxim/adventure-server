...
//#region node_modules/@vaadin/field-base/src/input-mixin.js
/**
* @license
...
*/
var InputMixinImplementation = (superclass) => {
	return class InputMixinClass extends superclass {
		...
		*/
		set _inputElementValue(value) {
			if (this.inputElement) this.inputElement[this._inputElementValueProperty] = value;
		}
		/**
		...
		*/
		_valueChanged(newVal, oldVal) {
			...
			if (newVal === "" && oldVal === void 0) return;
			if (this.__userInput) return;
			this._forwardInputValue(newVal);
		}
	};
};
var InputMixin = dedupeMixin(InputMixinImplementation);
//#endregion
export { InputMixin as t };

//# sourceMappingURL=input-mixin-d0kD3fa_.js.map