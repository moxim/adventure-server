//#region node_modules/@vaadin/component-base/src/define.js
/**
* @license
...
var experimentalMap = {};
function defineCustomElement(CustomElement, version = "25.2.7") {
	Object.defineProperty(CustomElement, "version", { get() {
		return version;
	} });
	...
	if (!defined) customElements.define(CustomElement.is, CustomElement);
	else {
		const definedVersion = defined.version;
		if (definedVersion && CustomElement.version && definedVersion === CustomElement.version) console.warn(`The component ${CustomElement.is} has been loaded twice`);
		else console.error(`Tried to define ${CustomElement.is} version ${CustomElement.version} when version ${defined.version} is already in use. Something will probably break.`);
	}
}
//#endregion
export { defineCustomElement };

//# sourceMappingURL=@vaadin_component-base_src_define__js.js.map