...
import { a as unlistenByKey, c as Disposable, l as FALSE, m as EventType_default$1, n as getUid, o as Target, r as listen, s as BaseEvent, t as abstract, u as TRUE, v as equals } from "./util-CuJ0gt1B.js";
import { i as CLASS_UNSELECTABLE, n as CLASS_CONTROL, r as CLASS_HIDDEN } from "./css-DK5RcH5d.js";
import { a as PASSIVE_EVENT_LISTENERS, n as DEVICE_PIXEL_RATIO } from "./has-CohifhXZ.js";
import { a as replaceChildren } from "./dom-mtKsj6k5.js";
import { n as MapEventType_default, t as Control } from "./Control-Bot7nb2G.js";
import { r as ObjectEventType_default, t as BaseObject } from "./Object-xCBDxpiD.js";
import { t as clear } from "./obj-BGAAjjDC.js";
import Attribution from "./ol_control_Attribution__js.js";
import { M as getForViewAndSize, P as getIntersection, V as getWidth, W as isEmpty, a as clone, p as createOrUpdateEmpty, v as equals$1 } from "./extent-DmAah91Y.js";
import { n as clamp } from "./math-CMFMV3TR.js";
import { D as toUserCoordinate, H as rotate, U as scale, W as wrapX, g as fromUserCoordinate, z as warn } from "./proj-R0q3-kiO.js";
import { r as CollectionEventType_default, t as Collection } from "./Collection-DH-uSFT4.js";
import { a as always, c as mouseOnly, d as primaryAction, f as shiftKeyOnly, g as zoomByDelta, h as pan, i as altShiftKeysOnly, l as noModifierKeys, m as Interaction, n as centroid, o as focusWithTabindex, p as targetNotEditable, r as all, s as mouseActionButton, t as PointerInteraction, u as platformModifierKey, v as MapBrowserEventType_default } from "./Pointer-BhoaZWnx.js";
import { t as TileState_default } from "./TileState--OC5z7qU.js";
import { t as assert } from "./asserts-CxKOIJBj.js";
import { o as disable, s as ViewHint_default, t as View } from "./View-BtJRu5rz.js";
import { n as easeOut } from "./easing-BXmlmOaZ.js";
import { a as makeInverse, n as compose, r as create, t as apply } from "./transform-NySQfU03.js";
import { t as Polygon } from "./Polygon-BKS3UHJl.js";
import Zoom from "./ol_control_Zoom__js.js";
import { a as BaseLayer, i as EventType_default$2, n as Layer, r as inView, t as RenderEvent } from "./Event-5frKf7gx.js";
import { t as hasArea } from "./size-Bir6Ad0C.js";
import { t as BaseVectorLayer } from "./BaseVector-BdOiKNxZ.js";
import { i as shared } from "./Fill-D7nksDX_.js";
import { c as checkedFonts } from "./Style-BMeM4QMn.js";
//#region node_modules/@vaadin/map/src/styles/vaadin-map-base-styles.js
/**
* @license
...
var LayerGroup = class LayerGroup extends BaseLayer {
	...
	*/
	registerLayerListeners_(layer) {
		...
		if (layer instanceof LayerGroup) listenerKeys.push(listen(layer, "addlayer", this.handleLayerGroupAdd_, this), listen(layer, "removelayer", this.handleLayerGroupRemove_, this));
...
var Map$1 = class extends BaseObject {
	...
	*/
	constructor(options) {
		...
		* @protected
		*/
		this.interactions = optionsInternal.interactions || defaults({ onFocusOnly: true });
		/**
...
//#endregion
//#region node_modules/@vaadin/map/src/vaadin-map-mixin.js
/**
* @license
* Copyright (c) 2000 - 2026 Vaadin Ltd.
*
...
var MapMixin = (superClass) => class extends FocusMixin(ResizeMixin(superClass)) {
	constructor() {
		...
		this._configuration = new Map$1(options);
	}
	/**
	...
	*/
	__addMapFocusListeners() {
		this._mapTarget.addEventListener("focusin", (e) => {
			if (e.target === this._mapTarget) this._setFocused(true);
		});
...
//#endregion
//#region node_modules/@vaadin/map/src/vaadin-map.js
/**
* @license
* Copyright (c) 2000 - 2026 Vaadin Ltd.
*
...
* @extends HTMLElement
*/
var Map = class extends MapMixin(ThemableMixin(ElementMixin(PolylitMixin(LumoInjectionMixin(LitElement))))) {
	static get is() {
		return "vaadin-map";
	}
	static get cvdlName() {
...
//# sourceMappingURL=@vaadin_map_src_vaadin-map__js.js.map