...
import { t as UploadManager } from "./vaadin-upload-manager-C3vVVQLn.js";
/**
* @license
* Copyright (c) 2000 - 2026 Vaadin Ltd.
* This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
*/
var uploadButtonStyles = [buttonStyles, css``];
//#endregion
//#region node_modules/@vaadin/upload/src/vaadin-upload-button.js
/**
* @license
* Copyright (c) 2000 - 2026 Vaadin Ltd.
* This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
...
* @extends HTMLElement
*/
var UploadButton = class extends ButtonMixin(ElementMixin(ThemableMixin(PolylitMixin(LumoInjectionMixin(LitElement))))) {
	static get is() {
	...
	*/
	...
	__updateFileInputAttributes() {
		...
		fileInput.multiple = (this.manager && this.manager.maxFiles != null ? this.manager.maxFiles : Infinity) !== 1;
		if (this.capture) fileInput.setAttribute("capture", this.capture);
		else fileInput.removeAttribute("capture");
	}
	/** @private */
	__onFileInputChange(event) {
		const files = event.target.files;
		if (this.manager instanceof UploadManager) this.manager.addFiles(files);
	}
	/** @private */
	__managerChanged(manager, oldManager) {
		...
		if (this.isConnected && manager instanceof UploadManager) {
			...
			this.__syncFromManager();
		} else if (this.isConnected) this.__syncFromManager();
	}
	/** @private */
	...
	/** @private */
	__syncFromManager() {
		if (this.manager instanceof UploadManager) this.maxFilesReached = this.manager.maxFilesReached;
		else this.maxFilesReached = false;
		super.disabled = this.__effectiveDisabled;
	}
	/** @override */
...
//# sourceMappingURL=@vaadin_upload_src_vaadin-upload-button__js.js.map