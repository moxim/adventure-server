import { s as BaseEvent } from "./util-CuJ0gt1B.js";
...
var Collection = class extends BaseObject {
	...
	*/
	assertUnique_(elem, except) {
		for (let i = 0, ii = this.array_.length; i < ii; ++i) if (this.array_[i] === elem && i !== except) throw new Error("Duplicate item added to a unique collection");
	}
};
//#endregion
export { CollectionEvent as n, CollectionEventType_default as r, Collection as t };

//# sourceMappingURL=Collection-DH-uSFT4.js.map