import { m as EventType_default, n as getUid, o as Target } from "./util-CuJ0gt1B.js";
import { n as getSharedCanvasContext2D, t as createCanvasContext2D } from "./dom-mtKsj6k5.js";
import { n as asArray, r as asString } from "./color-Ca7Tl5ca.js";
import { t as ImageState_default } from "./ImageState-C0YLe5GR.js";
import { r as decodeFallback } from "./Image-CrP-905j.js";
...
function get(image, cacheKey, crossOrigin, imageState, color, pattern) {
	...
	if (pattern && iconImage && !shared.getPattern(cacheKey, crossOrigin, color)) shared.set(cacheKey, crossOrigin, color, iconImage, pattern);
	return iconImage;
}
//#endregion
...
//# sourceMappingURL=Fill-D7nksDX_.js.map