...
//#region node_modules/@vaadin/message-list/src/styles/vaadin-message-base-styles.js
/**
* @license
...
`;
//#endregion
//#region node_modules/@vaadin/message-list/src/vaadin-message-mixin.js
/**
* @license
* Copyright (c) 2021 - 2026 Vaadin Ltd.
* This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
...
var MessageMixin = (superClass) => class MessageMixinClass extends FocusMixin(superClass) {
	...
	ready() {
		super.ready();
		this._avatarController = new SlotController(this, "avatar", "vaadin-avatar", { initializer: (avatar) => {
	...
	__avatarChanged(avatar, userName, userAbbr, userImg, userColorIndex) {
		if (avatar) avatar.setProperties({
			name: userName,
			abbr: userAbbr,
			img: userImg,
	...
	*/
	__renderAttachment(attachment) {
		if (attachment.type && attachment.type.startsWith("image/")) return html`
          <button
            type="button"
	...
	*/
	__onAttachmentClick(attachment) {
		this.dispatchEvent(new CustomEvent("attachment-click", { detail: { attachment } }));
	}
};
//#endregion
//#region node_modules/@vaadin/message-list/src/vaadin-message.js
/**
* @license
* Copyright (c) 2021 - 2026 Vaadin Ltd.
* This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
...
//#endregion
//#region node_modules/@vaadin/message-list/src/vaadin-message-list-mixin.js
/**
* @license
* Copyright (c) 2021 - 2026 Vaadin Ltd.
* This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
...
var MessageListMixin = (superClass) => class MessageListMixinClass extends KeyboardDirectionMixin(superClass) {
	...
	*/
	__onAttachmentClick(e, item) {
		this.dispatchEvent(new CustomEvent("attachment-click", { detail: {
			...e.detail,
			item
		} }));
	}
	...
	*/
	_focusItem(item, options, navigating) {
		...
		if (item && navigating) item.scrollIntoView({ block: "nearest" });
	}
	/** @private */
	_itemsChanged(newVal, oldVal) {
		...
		if (items.length || oldItems.length) {
			...
			if (oldItems.length) this.__enableScrollSnapping();
			requestAnimationFrame(() => {
				if (items.length > oldItems.length && closeToBottom) this._scrollToLastMessage();
			});
		}
	}
	/** @private */
	__markdownChanged(markdown) {
		if (markdown && !customElements.get("vaadin-markdown")) import("./@vaadin_markdown_src_vaadin-markdown__js.js").then(() => customElements.whenDefined("vaadin-markdown")).then(() => this._renderMessages(this.items));
	...
	_scrollToLastMessage() {
		if (this.items.length > 0) this.scrollTop = this.scrollHeight - this.clientHeight;
	}
	/** @private */
...
//#endregion
//#region node_modules/@vaadin/message-list/src/vaadin-message-list.js
/**
* @license
* Copyright (c) 2021 - 2026 Vaadin Ltd.
* This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
