...
//#region node_modules/@vaadin/login/src/styles/vaadin-login-form-wrapper-base-styles.js
/**
* @license
...
`;
//#endregion
//#region node_modules/@vaadin/login/src/vaadin-login-form-wrapper.js
/**
* @license
* Copyright (c) 2018 - 2026 Vaadin Ltd.
* This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
...
//#endregion
//#region node_modules/@vaadin/login/src/vaadin-login-mixin.js
/**
* @license
* Copyright (c) 2018 - 2026 Vaadin Ltd.
* This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
...
var LoginMixin = (superClass) => class LoginMixin extends I18nMixin(superClass) {
	static get properties() {
		return {
			/**
...
//#endregion
//#region node_modules/@vaadin/login/src/vaadin-login-form-mixin.js
/**
* @license
* Copyright (c) 2018 - 2026 Vaadin Ltd.
* This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
...
var LoginFormMixin = (superClass) => class LoginFormMixin extends LoginMixin(superClass) {
	...
	*/
	...
	updated(props) {
		super.updated(props);
		if (props.has("error") && this.error && !this._preventAutoEnable) this.disabled = false;
	}
	/** @protected */
	...
	*/
	submit() {
		...
		userName.validate();
		password.validate();
		if (this.disabled || userName.invalid || password.invalid) return;
		this.error = false;
		this.disabled = true;
		const detail = {
		...
		if (fields.length) {
			...
			fields.forEach((field) => {
				if (isCheckbox(field) && !field.checked) return;
	...
	_onFormData(event) {
		...
		if (this._customFields.length) this._customFields.forEach((field) => {
			if (isCheckbox(field) && !field.checked) return;
	...
	_handleInputKeydown(e) {
		if (e.key === "Enter") {
			...
			if (inputActive.validate()) if (nextInput.checkValidity()) this.submit();
	...
	_handleInputKeyup(e) {
		...
		if (e.key === "Tab" && input instanceof HTMLInputElement) input.select();
	}
	/** @protected */
...
//#endregion
export { LoginFormMixin as t };

//# sourceMappingURL=vaadin-login-form-mixin-Da8kuGgm.js.map