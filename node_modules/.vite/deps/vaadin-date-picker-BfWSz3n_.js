...
import { addListener } from "./@vaadin_component-base_src_gestures__js.js";
import { t as PolylitMixin } from "./polylit-mixin-BwU08z1T.js";
import { t as KeyboardMixin } from "./keyboard-mixin-D_F3Z86Y.js";
...
import { o as isKeyboardActive, r as isElementFocusable } from "./focus-utils-CzjQXswF.js";
import { t as FocusMixin } from "./focus-mixin-BGjk0FWO.js";
import { t as DelegateFocusMixin } from "./delegate-focus-mixin-D1xxz8VY.js";
import { t as generateUniqueId } from "./unique-id-utils-C7-gNk0a.js";
...
import { t as inputFieldShared } from "./input-field-shared-styles-CTATZMFP.js";
import { n as InputConstraintsMixin, t as InputControlMixin } from "./input-control-mixin-CHzREIdf.js";
import { t as VirtualKeyboardController } from "./virtual-keyboard-controller-BmX4r5ri.js";
import { t as MediaQueryController } from "./media-query-controller-DXI7eY7g.js";
import { dateAfterXMonths, dateAllowed, dateEquals, extractDateParts, formatISODate, getAdjustedYear, getClosestDate, getISOWeekNumber, normalizeDate, parseDate } from "./@vaadin_date-picker_src_vaadin-date-picker-helper__js.js";
//#region node_modules/@vaadin/date-picker/src/styles/vaadin-date-picker-overlay-base-styles.js
/**
* @license
...
`;
//#endregion
//#region node_modules/@vaadin/date-picker/src/vaadin-date-picker-overlay-mixin.js
/**
* @license
...
var DatePickerOverlayMixin = (superClass) => class DatePickerOverlayMixin extends PositionMixin(OverlayMixin(superClass)) {
	...
	*/
	_shouldCloseOnOutsideClick(event) {
		return !event.composedPath().includes(this.positionTarget);
	}
	/**
	* @protected
	* @override
	*/
	_mouseDownListener(event) {
		...
		if (this._shouldCloseOnOutsideClick(event) && !isElementFocusable(event.composedPath()[0])) event.preventDefault();
	}
};
//#endregion
//#region node_modules/@vaadin/date-picker/src/vaadin-date-picker-overlay.js
/**
* @license
* Copyright (c) 2016 - 2026 Vaadin Ltd.
* This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
...
* @private
*/
var DatePickerOverlay = class extends DatePickerOverlayMixin(DirMixin(ThemableMixin(PolylitMixin(LumoInjectionMixin(LitElement))))) {
	static get is() {
...
//#endregion
//#region node_modules/@vaadin/date-picker/src/vaadin-infinite-scroller.js
/**
* @license
* Copyright (c) 2016 - 2026 Vaadin Ltd.
* This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
...
var InfiniteScroller = class extends HTMLElement {
	...
	*/
	set position(index) {
		...
		if (index > this._firstIndex && index < this._firstIndex + this.bufferSize * 2) this.$.scroller.scrollTop = this.itemHeight * (index - this._firstIndex) + this._buffers[0].translateY;
		else {
	...
	disconnectedCallback() {
		if (this._debouncerScrollFinish) this._debouncerScrollFinish.cancel();
		if (this._debouncerUpdateClones) this._debouncerUpdateClones.cancel();
		if (this.__pendingFinishInit) cancelAnimationFrame(this.__pendingFinishInit);
	}
	/**
	...
	*/
	forceUpdate() {
		if (this._debouncerScrollFinish) this._debouncerScrollFinish.flush();
	...
	*/
	...
	_finishInit() {
		if (!this._initDone) {
			...
			if (!this._buffers[0].translateY) this._reset();
			this._initDone = true;
	...
	_scroll() {
		...
		if (!this._preventScrollEvent) this.dispatchEvent(new CustomEvent("custom-scroll", {
			bubbles: false,
			composed: true
		}));
		...
		this._debouncerScrollFinish = Debouncer.debounce(this._debouncerScrollFinish, timeOut.after(200), () => {
			...
			if (!this._isVisible(this._buffers[0], scrollerRect) && !this._isVisible(this._buffers[1], scrollerRect)) this.position = this.position;
		});
	}
	/** @private */
	_reset() {
	...
	_createPool() {
		...
		this._buffers.forEach((buffer) => {
			for (let i = 0; i < this.bufferSize; i++) {
				...
				if (this.itemHeight * i <= viewportHeight) this._ensureStampedInstance(itemWrapper);
			}
		});
		...
		this._buffers.forEach((buffer, bufferIndex) => {
			if (!buffer.updated) {
				...
				[...buffer.children].forEach((slot, index) => {
					...
					if (!viewPortOnly || this._isVisible(itemWrapper, scrollerRect)) this._updateElement(itemWrapper.instance, firstIndex + index);
				});
				buffer.updated = true;
			}
		});
...
//#endregion
//#region node_modules/@vaadin/date-picker/src/vaadin-date-picker-month-scroller.js
/**
* @license
* Copyright (c) 2016 - 2026 Vaadin Ltd.
* This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
...
//#endregion
//#region node_modules/@vaadin/date-picker/src/vaadin-date-picker-year-scroller.js
/**
* @license
* Copyright (c) 2016 - 2026 Vaadin Ltd.
* This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
...
//#endregion
//#region node_modules/@vaadin/date-picker/src/styles/vaadin-date-picker-year-base-styles.js
/**
* @license
* Copyright (c) 2016 - 2026 Vaadin Ltd.
* This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
...
`;
//#endregion
//#region node_modules/@vaadin/date-picker/src/vaadin-date-picker-year.js
/**
* @license
* Copyright (c) 2016 - 2026 Vaadin Ltd.
* This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
...
var DatePickerYear = class extends ThemableMixin(PolylitMixin(LumoInjectionMixin(LitElement))) {
	...
	updated(props) {
		super.updated(props);
		if (props.has("year")) this.toggleAttribute("current", this.year === (/* @__PURE__ */ new Date()).getFullYear());
		if (props.has("year") || props.has("selectedDate")) this.toggleAttribute("selected", this.selectedDate && this.selectedDate.getFullYear() === this.year);
	}
};
defineCustomElement(DatePickerYear);
//#endregion
//#region node_modules/@vaadin/date-picker/src/styles/vaadin-month-calendar-base-styles.js
/**
* @license
* Copyright (c) 2016 - 2026 Vaadin Ltd.
* This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
...
`;
//#endregion
//#region node_modules/@vaadin/date-picker/src/vaadin-month-calendar-mixin.js
/**
* @license
* Copyright (c) 2016 - 2026 Vaadin Ltd.
* This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
...
var MonthCalendarMixin = (superClass) => class MonthCalendarMixinClass extends FocusMixin(superClass) {
	static get properties() {
		return {
			...
			*/
			...
			/** @private */
			_notTapping: { type: Boolean },
			/** @private */
			__hasFocus: { type: Boolean }
		};
	}
	...
	*/
	__computeDisabled(month, minDate, maxDate) {
		...
		lastDate.setDate(0);
		if (minDate && maxDate && minDate.getMonth() === maxDate.getMonth() && minDate.getMonth() === month.getMonth() && maxDate.getDate() - minDate.getDate() >= 0) return false;
		return !dateAllowed(firstDate, minDate, maxDate) && !dateAllowed(lastDate, minDate, maxDate);
	}
	/** @protected */
	_getTitle(month, i18n) {
		if (month === void 0 || i18n === void 0) return;
	...
	_applyFirstDayOfWeek(weekDayNames, firstDayOfWeek) {
		if (weekDayNames === void 0 || firstDayOfWeek === void 0) return;
		return weekDayNames.slice(firstDayOfWeek).concat(weekDayNames.slice(0, firstDayOfWeek));
	}
	/** @protected */
	__computeWeekDayNames(i18n, showWeekNumbers) {
		if (i18n === void 0 || showWeekNumbers === void 0) return [];
		...
		return this._applyFirstDayOfWeek(weekdays, firstDayOfWeek).map((day, index) => {
			return {
				weekDay: day,
	...
	__focusedDateChanged(focusedDate, days) {
		if (Array.isArray(days) && days.some((date) => dateEquals(date, focusedDate))) this.removeAttribute("aria-hidden");
	...
	__computeDays(month, i18n) {
		...
		date.setDate(1);
		while (date.getDay() !== i18n.firstDayOfWeek) this._dateAdd(date, -1);
		const days = [];
	...
	__computeWeekNumber(days) {
		return getISOWeekNumber(days.reduce((acc, d) => {
			return !acc && d ? d : acc;
		}));
	}
	/** @protected */
	__computeDayAriaLabel(date) {
		...
		if (this._isToday(date)) ariaLabel += `, ${this.i18n.today}`;
		return ariaLabel;
	}
	/** @private */
	_showWeekNumbersChanged(showWeekNumbers, i18n) {
		if (this.__computeShowWeekSeparator(showWeekNumbers, i18n)) this.setAttribute("week-numbers", "");
		else this.removeAttribute("week-numbers");
	}
	__computeDatePart(date, focusedDate, selectedDate, minDate, maxDate, isDateDisabled, enteredDate, hasFocus) {
		const result = ["date"];
		if (this.__isDayDisabled(date, minDate, maxDate, isDateDisabled)) result.push("disabled");
		if (dateEquals(date, focusedDate) && (hasFocus || dateEquals(date, enteredDate))) result.push("focused");
		if (this.__isDaySelected(date, selectedDate)) result.push("selected");
		if (this._isToday(date)) result.push("today");
		if (date < normalizeDate(/* @__PURE__ */ new Date())) result.push("past");
		if (date > normalizeDate(/* @__PURE__ */ new Date())) result.push("future");
		return result.join(" ");
	}
	/** @private */
	...
	__computeDayAriaDisabled(date, min, max, isDateDisabled) {
		if (date === void 0 || min === void 0 && max === void 0 && isDateDisabled === void 0) return "false";
...
//#endregion
//#region node_modules/@vaadin/date-picker/src/vaadin-month-calendar.js
/**
* @license
* Copyright (c) 2016 - 2026 Vaadin Ltd.
* This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
        ...
        <tbody id="days-container">
          ${weeks.map((week) => html`
			...
			return html`
                    <td
                      role="gridcell"
                      part="${this.__computeDatePart(date, this.focusedDate, this.selectedDate, this.minDate, this.maxDate, this.isDateDisabled, this.enteredDate, this.__hasFocus)}"
                      .date="${date}"
                      ...
                      aria-disabled="${this.__computeDayAriaDisabled(date, this.minDate, this.maxDate, this.isDateDisabled)}"
...
//#endregion
//#region node_modules/@vaadin/date-picker/src/styles/vaadin-date-picker-overlay-content-base-styles.js
/**
* @license
* Copyright (c) 2016 - 2026 Vaadin Ltd.
* This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
...
`;
//#endregion
//#region node_modules/@vaadin/date-picker/src/vaadin-date-picker-overlay-content-mixin.js
/**
* @license
* Copyright (c) 2016 - 2026 Vaadin Ltd.
* This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
...
var DatePickerOverlayContentMixin = (superClass) => class DatePickerOverlayContentMixin extends superClass {
	static get properties() {
		return {
			...
			*/
			label: String,
			_cancelButton: { type: Object },
			_todayButton: { type: Object },
			calendars: {
				type: Array,
				value: () => []
			},
	...
	*/
	...
	__updateCancelButton(cancelButton, i18n) {
		if (cancelButton) cancelButton.textContent = i18n?.cancel;
	}
	/** @private */
	...
	__updateCalendars(calendars, i18n, minDate, maxDate, selectedDate, focusedDate, showWeekNumbers, ignoreTaps, theme, isDateDisabled, enteredDate) {
		if (calendars?.length) calendars.forEach((calendar) => {
			calendar.i18n = i18n;
			...
			if (theme) calendar.setAttribute("theme", theme);
			else calendar.removeAttribute("theme");
		});
	}
	/** @private */
	__updateYears(years, selectedDate, theme) {
		if (years?.length) years.forEach((year) => {
			year.selectedDate = selectedDate;
			if (theme) year.setAttribute("theme", theme);
			else year.removeAttribute("theme");
		});
	}
	/**
	...
	*/
	_selectDate(dateToSelect) {
		if (!this._dateAllowed(dateToSelect)) return false;
		this.selectedDate = dateToSelect;
		this.dispatchEvent(new CustomEvent("date-selected", {
			detail: { date: dateToSelect },
			bubbles: true,
			composed: true
		}));
		return true;
	...
	*/
	revealDate(date, animate = true) {
		...
		const visibleItems = Math.max(this._monthScroller.itemHeight, this._monthScroller.clientHeight - this._monthScroller.bufferOffset * 2) / this._monthScroller.itemHeight;
		const scrolledBelowViewport = this._monthScroller.position + visibleItems - 1 < diff;
		if (scrolledAboveViewport) this._scrollToPosition(diff, animate);
		else if (scrolledBelowViewport) this._scrollToPosition(diff - visibleItems + 1, animate);
	}
	/**
	...
	*/
	_calculateWeekScrollOffset(date) {
		...
		while (temp.getDate() < date.getDate()) {
			...
			if (temp.getDay() === this.i18n.firstDayOfWeek) week += 1;
		}
		return week / 6;
	}
	/** @private */
	...
	_onTodayTap() {
		...
		if (Math.abs(this._monthScroller.position - this._differenceInMonths(today, this._originDate)) < .001) {
			this._selectDate(today);
			this._close();
		} else this._scrollToCurrentMonth();
	}
	/** @private */
	_scrollToCurrentMonth() {
		if (this.focusedDate) this.focusedDate = /* @__PURE__ */ new Date();
		this.scrollToDate(/* @__PURE__ */ new Date(), true);
	}
	/** @private */
	_onYearTap(e) {
		if (!this._ignoreTaps && !this._notTapping) {
			const yearDelta = (e.detail.y - (this._yearScroller.getBoundingClientRect().top + this._yearScroller.clientHeight / 2)) / this._yearScroller.itemHeight;
	...
	_differenceInMonths(date1, date2) {
		return (date1.getFullYear() - date2.getFullYear()) * 12 - date2.getMonth() + date1.getMonth();
	}
	/** @private */
	_clear() {
		this._selectDate("");
	...
	_onTabKeyDown(event, section) {
		...
		switch (section) {
			case "calendar":
				if (event.shiftKey) {
					event.preventDefault();
					if (this.hasAttribute("fullscreen")) this.focusCancel();
					else this.__focusInput();
				}
				break;
			case "today":
				if (event.shiftKey) {
			...
			case "cancel":
				if (!event.shiftKey) {
					event.preventDefault();
					if (this.hasAttribute("fullscreen")) this.focusDateElement();
					else this.__focusInput();
				}
				break;
			default: break;
	...
	__onTodayButtonKeyDown(event) {
		if (event.key === "Tab") this._onTabKeyDown(event, "today");
	}
	/** @private */
	__onCancelButtonKeyDown(event) {
		if (event.key === "Tab") this._onTabKeyDown(event, "cancel");
	}
	/** @private */
	__focusInput() {
	...
	async focusDate(date, keepMonth) {
		...
		if (!keepMonth) this._focusedMonthDate = dateToFocus.getDate();
		await this.focusDateElement(false);
	}
	async focusDateElement(reveal = true) {
		this.__pendingDateFocus = this.focusedDate;
		if (!this.calendars.length) await new Promise((resolve) => {
		...
		if (reveal) this.revealDate(this.focusedDate);
		if (this._revealPromise) await this._revealPromise;
		this.__tryFocusDate();
	}
	/** @private */
	...
	_focusAllowedDate(dateToFocus, diff, keepMonth) {
		if (this._dateAllowed(dateToFocus, void 0, void 0, () => false)) this.focusDate(dateToFocus, keepMonth);
		else if (this._dateAllowed(this.focusedDate)) if (diff > 0) this.focusDate(this.maxDate);
		else this.focusDate(this.minDate);
		else this._focusClosestDate(this.focusedDate);
	}
	/** @private */
	_getDateDiff(months, days) {
		...
		if (days) date.setDate(this.focusedDate.getDate() + days);
		return date;
	}
	/** @private */
	...
	_moveFocusByMonths(months) {
		...
		if (!this._focusedMonthDate) this._focusedMonthDate = this.focusedDate.getDate();
		dateToFocus.setDate(this._focusedMonthDate);
		if (dateToFocus.getMonth() !== targetMonth) dateToFocus.setDate(0);
	...
	_moveFocusInsideMonth(focusedDate, property) {
		...
		if (this._dateAllowed(dateToFocus)) this.focusDate(dateToFocus);
		else if (this._dateAllowed(focusedDate)) this.focusDate(this[property]);
		else this._focusClosestDate(focusedDate);
	}
	/** @private */
...
//#endregion
//#region node_modules/@vaadin/date-picker/src/vaadin-date-picker-overlay-content.js
/**
* @license
* Copyright (c) 2016 - 2026 Vaadin Ltd.
* This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
...
* @private
*/
var DatePickerOverlayContent = class extends DatePickerOverlayContentMixin(ThemableMixin(DirMixin(PolylitMixin(LumoInjectionMixin(LitElement))))) {
	static get is() {
...
//#endregion
//#region node_modules/@vaadin/date-picker/src/styles/vaadin-date-picker-base-styles.js
/**
* @license
* Copyright (c) 2016 - 2026 Vaadin Ltd.
* This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
...
`;
//#endregion
//#region node_modules/@vaadin/date-picker/src/vaadin-date-picker-mixin.js
/**
* @license
* Copyright (c) 2016 - 2026 Vaadin Ltd.
* This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
...
var datePickerI18nDefaults = Object.freeze({
	...
	parseDate(text) {
		...
		if (parts.length === 3) {
			...
			if (parts[2].length < 3 && year >= 0) year = getAdjustedYear(this.referenceDate ? parseDate(this.referenceDate) : /* @__PURE__ */ new Date(), year, month, date);
		} else if (parts.length === 2) {
			month = parseInt(parts[0]) - 1;
			date = parseInt(parts[1]);
		} else if (parts.length === 1) date = parseInt(parts[0]);
...
var DatePickerMixin = (subclass) => class DatePickerMixinClass extends I18nMixin(DelegateFocusMixin(InputConstraintsMixin(KeyboardMixin(subclass)))) {
	static get properties() {
		return {
			/**
			...
			* @protected
			*/
			_fullscreenMediaQuery: { value: "(max-width: 450px), (max-height: 450px)" },
			/**
			* The earliest date that can be selected. All earlier dates will be disabled.
			*
			* Supported date formats:
	...
	*/
	get __unparsableValue() {
		if (!this._inputElementValue || this.__parseDate(this._inputElementValue)) return "";
	...
	*/
	_onFocus(event) {
		...
		if (this._noInput && !isKeyboardActive()) event.target.blur();
	}
	/**
	* Override an event listener from `DelegateFocusMixin`
	* @protected
	*/
	_onBlur(event) {
		...
		if (!this.opened) {
			...
			if (document.hasFocus()) this._requestValidation();
		}
	}
	/** @protected */
	ready() {
	...
	updated(props) {
		super.updated(props);
		if (props.has("showWeekNumbers") || props.has("__effectiveI18n")) this.toggleAttribute("week-numbers", this.showWeekNumbers && this.__effectiveI18n.firstDayOfWeek === 1);
	}
	/** @protected */
	disconnectedCallback() {
	...
	*/
	focus(options) {
		if (this._noInput && !isKeyboardActive()) this.open();
	...
	*/
	...
	__ensureContent() {
		...
		content.addEventListener("focusin", () => {
			if (this._keyboardActive) this._setFocused(true);
		});
		content.addEventListener("focusout", (event) => {
			if (this._shouldRemoveFocus(event)) this._setFocused(false);
		});
	...
	*/
	__parseDate(dateString) {
		if (!this.__effectiveI18n.parseDate) return;
		let dateObject = this.__effectiveI18n.parseDate(dateString);
		if (dateObject) dateObject = parseDate(`${dateObject.year}-${dateObject.month + 1}-${dateObject.day}`);
		if (dateObject && !isNaN(dateObject.getTime())) return dateObject;
	}
	/**
	...
	*/
	__formatDate(dateObject) {
		if (this.__effectiveI18n.formatDate) return this.__effectiveI18n.formatDate(extractDateParts(dateObject));
	}
	/**
	...
	*/
	checkValidity() {
		...
		if (this.inputElement && this.inputElement.checkValidity) inputValidity = this.inputElement.checkValidity();
	...
	*/
	_shouldRemoveFocus(event) {
		...
		if (this.opened && relatedTarget !== null && relatedTarget !== document.body && !this.contains(relatedTarget) && !this._overlayContent.contains(relatedTarget)) return true;
		return !this.opened;
	}
	/**
	* Override method inherited from `FocusMixin`
	...
	*/
	...
	_isNoInput(inputElement, fullscreen, ios, effectiveI18n, opened, autoOpenDisabled) {
		return !inputElement || fullscreen && (!autoOpenDisabled || opened) || ios && opened || !effectiveI18n.parseDate;
	}
	/** @private */
	_formatISO(date) {
	...
	_openedChanged(opened) {
		if (opened) this.__ensureContent();
		if (this.inputElement) this.inputElement.setAttribute("aria-expanded", opened);
	}
	/** @private */
	_selectedDateChanged(selectedDate, effectiveI18n) {
		if (selectedDate === void 0 || effectiveI18n === void 0) return;
		if (!this.__keepInputValue) this._applyInputValue(selectedDate);
	...
	_focusedDateChanged(focusedDate, effectiveI18n) {
		if (focusedDate === void 0 || effectiveI18n === void 0) return;
		if (!this._ignoreFocusedDateChange && !this._noInput) this._applyInputValue(focusedDate);
	}
	/**
	...
	*/
	_valueChanged(value, oldValue) {
		...
		if (value) {
			if (!dateEquals(this._selectedDate, newDate)) {
				...
				if (oldValue !== void 0) this._requestValidation();
			}
	...
	__updateOverlayContentTheme(overlayContent, theme) {
		if (overlayContent) if (theme) overlayContent.setAttribute("theme", theme);
		else overlayContent.removeAttribute("theme");
	}
	/** @private */
	__updateOverlayContentFullScreen(overlayContent, fullscreen) {
		if (overlayContent) overlayContent.toggleAttribute("fullscreen", fullscreen);
	}
	/** @protected */
	...
	*/
	__commitParsedOrFocusedDate() {
		...
		if (this.__effectiveI18n.parseDate) {
			...
			if (parsedDate) this.__commitDate(parsedDate);
			else {
				this.__keepInputValue = true;
				this.__commitDate(null);
				this.__keepInputValue = false;
			}
		} else if (this._focusedDate) this.__commitDate(this._focusedDate);
		this._ignoreFocusedDateChange = false;
	}
	/** @protected */
	_onOverlayClosed() {
		...
		this.__commitParsedOrFocusedDate();
		if (this.inputElement && this.inputElement.selectionStart) this.inputElement.selectionStart = this.inputElement.selectionEnd;
		if (!this.value && !this._keyboardActive) this._requestValidation();
	}
	/** @private */
	_onScroll(e) {
		if (e.target === window || !this._overlayContent.contains(e.target)) this._overlayContent._repositionYearScroller();
	}
	/** @protected */
	_focus() {
		if (!this._noInput) this.inputElement.focus();
	}
	/** @private */
	_focusAndSelect() {
		this._focus();
	...
	_setSelectionRange(a, b) {
		if (this.inputElement) this.inputElement.setSelectionRange(a, b);
	}
	/**
	...
	*/
	_onClick(event) {
		if (event.composedPath().includes(this._overlayElement)) return;
		if (!this._isClearButton(event)) this._onHostClick(event);
	}
	/**
	* @param {Event} event
	* @private
	...
	*/
	_onKeyDown(e) {
		super._onKeyDown(e);
		if (this._noInput) {
			if (["Tab", "Escape"].indexOf(e.key) === -1) e.preventDefault();
		}
		switch (e.key) {
			case "ArrowDown":
			case "ArrowUp":
				e.preventDefault();
				if (this.opened) this._overlayContent.focusDateElement();
				else {
			...
			case "Tab":
				if (this.opened) {
					...
					if (e.shiftKey) this._overlayContent.focusCancel();
					else this._overlayContent.focusDateElement();
				}
				break;
			default: break;
		}
	...
	*/
	_onEnter(event) {
		if (event.composedPath().includes(this._overlayContent)) return;
		if (this.opened) this.close();
		else this.__commitParsedOrFocusedDate();
	}
	/**
	* Override an event listener from `KeyboardMixin`.
	...
	*/
	_onEscape(event) {
		...
		if (this.inputElement.value === "") this.__commitDate(null);
		else this._applyInputValue(this._selectedDate);
	}
	/** @protected */
	...
	*/
	_onInput() {
		if (!this.opened && this._inputElementValue && !this.autoOpenDisabled) this.open();
		const parsedDate = this.__parseDate(this._inputElementValue || "");
		if (parsedDate) {
			this._ignoreFocusedDateChange = true;
			if (!dateEquals(parsedDate, this._focusedDate)) this._focusedDate = parsedDate;
			this._ignoreFocusedDateChange = false;
		}
		this.__setEnteredDate(parsedDate);
	}
	...
	*/
	__setEnteredDate(date) {
		if (date) {
			if (!dateEquals(this.__enteredDate, date)) this.__enteredDate = date;
		} else this.__enteredDate = null;
	}
	/** @private */
...
//#endregion
//#region node_modules/@vaadin/date-picker/src/vaadin-date-picker.js
/**
* @license
* Copyright (c) 2016 - 2026 Vaadin Ltd.
* This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
...
* @extends HTMLElement
*/
var DatePicker = class extends DatePickerMixin(InputControlMixin(ThemableMixin(ElementMixin(PolylitMixin(LumoInjectionMixin(LitElement)))))) {
	static get is() {
...
_positionTarget: {
	...
	*/
	...
	ready() {
		...
		this.shadowRoot.querySelector("[part=\"field-button toggle-button\"]").addEventListener("mousedown", (e) => e.preventDefault());
	}
	/** @private */
	...
	_onVaadinOverlayClose(e) {
		...
		if (event?.composedPath().includes(this) && !event.composedPath().includes(this._overlayElement)) e.preventDefault();
	}
	/** @private */
	_toggle(e) {
		e.stopPropagation();
		if (this.$.overlay.opened) this.close();
		else this.open();
	}
};
defineCustomElement(DatePicker);
//#endregion
export { datePickerI18nDefaults as n, DatePicker as t };

//# sourceMappingURL=vaadin-date-picker-BfWSz3n_.js.map