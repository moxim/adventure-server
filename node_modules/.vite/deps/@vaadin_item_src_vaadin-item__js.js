...
//#region node_modules/@vaadin/item/src/vaadin-item.js
/**
* @license
...
* @extends HTMLElement
*/
var Item = class extends ItemMixin(ThemableMixin(DirMixin(PolylitMixin(LumoInjectionMixin(LitElement))))) {
	static get is() {
		return "vaadin-item";
	}
	static get styles() {
...
//# sourceMappingURL=@vaadin_item_src_vaadin-item__js.js.map