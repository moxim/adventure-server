...
import { a as nothing, n as html, o as render } from "./lit-html-x1Rck0rJ.js";
...
import { s as FocusRestorationController, t as OverlayMixin } from "./vaadin-overlay-mixin-Cp6vfu5u.js";
import { t as ifDefined } from "./if-defined-HGTsiUgW.js";
import "./@vaadin_button_src_vaadin-button__js.js";
import { r as dialogOverlayStyles } from "./vaadin-dialog-size-mixin-C5bt7ZJI.js";
import "./vaadin-confirm-dialog-BR30WJ_D.js";
import { t as MediaQueryController } from "./media-query-controller-DXI7eY7g.js";
import { a as getProperty, i as createFields, n as capitalize, o as isValidEditorPosition, r as createField, s as setProperty } from "./vaadin-crud-edit-column-CYzDWbjL.js";
import "./@vaadin_grid_src_vaadin-grid-column__js.js";
import { n as DialogOverflowController, t as DialogBaseMixin } from "./vaadin-dialog-base-mixin-Bbc7Kx88.js";
import "./@vaadin_grid_src_vaadin-grid-column-group__js.js";
import "./vaadin-text-field-CttvI2rY.js";
import "./vaadin-grid-sorter-D63hPrX0.js";
import { n as gridStyles, t as Grid } from "./vaadin-grid-Ba7vVF3C.js";
import { t as FormLayout } from "./vaadin-form-layout-BfS3ZXp9.js";
//#region node_modules/@vaadin/crud/src/styles/vaadin-crud-dialog-overlay-base-styles.js
/**
* @license
...
//#endregion
//#region node_modules/@vaadin/crud/src/vaadin-crud-dialog-overlay.js
/**
* @license
* Copyright (c) 2000 - 2026 Vaadin Ltd.
*
...
//#endregion
//#region node_modules/@vaadin/crud/src/vaadin-crud-dialog.js
/**
* @license
* Copyright (c) 2000 - 2026 Vaadin Ltd.
*
...
//#endregion
//#region node_modules/@vaadin/grid/src/styles/vaadin-grid-filter-base-styles.js
/**
* @license
...
`;
//#endregion
//#region node_modules/@vaadin/grid/src/vaadin-grid-filter-element-mixin.js
/**
* @license
* Copyright (c) 2016 - 2026 Vaadin Ltd.
* This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
...
var GridFilterElementMixin = (superClass) => class extends superClass {
	...
	ready() {
		super.ready();
		this._filterController = new SlotController(this, "", "vaadin-text-field", { initializer: (field) => {
	...
	_filterChanged(path, value, textField) {
		if (path === void 0 || value === void 0 || !textField) return;
...
//#endregion
//#region node_modules/@vaadin/grid/src/vaadin-grid-filter.js
/**
* @license
* Copyright (c) 2016 - 2026 Vaadin Ltd.
* This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
...
* license.
*/
var crudGridStyles = [gridStyles, css`
  #scroller {
    border-radius: inherit;
  }
`];
//#endregion
//#region node_modules/@vaadin/crud/src/vaadin-crud-include-mixin.js
/**
* @license
* Copyright (c) 2000 - 2026 Vaadin Ltd.
*
...
var IncludedMixin = (superClass) => class IncludedMixin extends superClass {
	...
	__onExcludeChange(exclude) {
		if (typeof exclude === "string") this.exclude = exclude ? RegExp(exclude.replace(/, */gu, "|"), "iu") : void 0;
	}
	/** @private */
	__onIncludeChange(include) {
		if (typeof include === "string") this.include = include ? include.split(/, */u) : void 0;
...
//#endregion
//#region node_modules/@vaadin/crud/src/vaadin-crud-grid-mixin.js
/**
* @license
* Copyright (c) 2000 - 2026 Vaadin Ltd.
*
...
var CrudGridMixin = (superClass) => class extends IncludedMixin(superClass) {
	...
	__onItemsChange(items) {
		if ((!this.dataProvider || this.dataProvider === this._arrayDataProvider) && !this.include && items?.[0]) this._configure(items[0]);
	}
	/** @private */
	__onHideEditColumnChange() {
		if (this.firstChild) this.__toggleEditColumn();
	}
	/** @private */
	__toggleEditColumn() {
		let editColumn = this.querySelector("vaadin-crud-edit-column");
		if (this.hideEditColumn) {
			if (editColumn) this.removeChild(editColumn);
		} else if (!editColumn) {
	...
	__dataProviderWrapper(params, callback) {
		this.__dataProvider(params, (items, size) => {
			if (this.innerHTML === "" && !this.include && items[0]) this._configure(items[0]);
			callback(items, size);
		});
	}
	/**
	...
	*/
	_dataProviderChanged(dataProvider, oldDataProvider) {
		if (this._arrayDataProvider === dataProvider) super._dataProviderChanged(dataProvider, oldDataProvider);
	...
	*/
	__getPropertyDepth(object) {
		...
		return Object.keys(object).reduce((deepest, prop) => {
			if (this.exclude && this.exclude.test(prop)) return deepest;
	...
	*/
	...
	__createColumn(parent, path) {
		...
		if (!this.noHead && path) col.headerRenderer = (root) => {
			...
			if (col.__sortColumnGroup || this.noFilter && !this.noSort) {
				...
				if (this.noSort) textField.placeholder = label;
				textField.addEventListener("value-changed", (event) => {
					filter.value = event.detail.value;
				});
				filter.appendChild(textField);
				root.appendChild(filter);
			} else if (this.noSort && this.noFilter) root.textContent = label;
		};
	}
	/**
	...
	*/
	__createColumns(parent, object, path, depth) {
		if (object && typeof object === "object") Object.keys(object).forEach((prop) => {
			if (!this.include && this.exclude && this.exclude.test(prop)) return;
		...
		else if (depth > 1) this.__createColumns(this.__createGroup(parent), void 0, path, depth - 1);
		else this.__createColumn(parent, path);
	}
	/** @private */
	__createGroup(parent, header) {
		const grp = document.createElement("vaadin-grid-column-group");
		if (header) grp.header = capitalize(header);
		parent.appendChild(grp);
		return grp;
	}
};
//#endregion
//#region node_modules/@vaadin/crud/src/vaadin-crud-grid.js
/**
* @license
* Copyright (c) 2000 - 2026 Vaadin Ltd.
*
...
//#endregion
//#region node_modules/@vaadin/crud/src/vaadin-crud-form.js
/**
* @license
* Copyright (c) 2000 - 2026 Vaadin Ltd.
*
...
item: {
	...
	*/
	...
	/** @private */
	__onItemChange(item) {
		if (!this._fields) this._configure(item);
	}
	/** @private */
...
//#endregion
//#region node_modules/@vaadin/crud/src/styles/vaadin-crud-base-styles.js
/**
* @license
* Copyright (c) 2000 - 2026 Vaadin Ltd.
*
...
`;
//#endregion
//#region node_modules/@vaadin/crud/src/vaadin-crud-controllers.js
/**
* @license
* Copyright (c) 2000 - 2026 Vaadin Ltd.
*
...
var ButtonSlotController = class extends SlotController {
	...
	*/
	initNode(node) {
		if (!node) return;
		if (node._isDefault) this.defaultNode = node;
		if (node === this.defaultNode && this.theme && !node.hasAttribute("theme")) node.setAttribute("theme", this.theme);
		const { host, type } = this;
		const property = `_${type}Button`;
		const listener = `__${type}`;
		if (host[property] && host[property] !== node) host[property].remove();
...
var FormSlotController = class extends SlotController {
	...
	*/
	initNode(node) {
		...
		if (this.host.editorOpened) this.host.__ensureChildren();
	}
};
/**
...
//#endregion
//#region node_modules/@vaadin/crud/src/vaadin-crud-mixin.js
/**
* @license
* Copyright (c) 2000 - 2026 Vaadin Ltd.
*
...
*/
var CrudMixin = (superClass) => class extends I18nMixin(superClass) {
	static get properties() {
		return {
			/**
			...
			* @private
			*/
			_defaultHeader: { type: Object },
			/**
			* A reference to the "New item" button
			* @private
			*/
			_newButton: { type: Object },
			/**
			...
			* @protected
			*/
			_fullscreenMediaQuery: { value: "(max-width: 600px), (max-height: 600px)" }
		};
	}
	static get observers() {
		return [
	...
	*/
	get _fields() {
		if (!this.__fields || !this.__fields.length) this.__fields = Array.from(this._form.querySelectorAll("*")).filter((e) => e.validate || e.checkValidity);
	...
	ready() {
		...
		this._headerController = new SlotController(this, "header", "h3", { initializer: (node) => {
	...
	*/
	__headerPropsChanged(headerNode, isNew, effectiveI18n) {
		if (headerNode) headerNode.textContent = isNew ? effectiveI18n.newItem : effectiveI18n.editItem;
	}
	/**
	* @param {CrudI18n} effectiveI18n
	...
	*/
	...
	__editorPositionChanged(editorPosition) {
		if (isValidEditorPosition(editorPosition)) return;
		this.editorPosition = "";
	}
	/** @private */
	__editorOpenedChanged(opened, oldOpened) {
		if (!opened && oldOpened) this.__closeEditor();
		else this.__formChanged(this._form);
		if (opened) {
	...
	/** @private */
	__toggleToolbar() {
		if (this.editorPosition === "bottom" && !this._fullscreen) this.$.toolbar.style.display = this.editorOpened ? "none" : "";
	}
	/** @private */
	__onGridEdit(event) {
	...
	*/
	__gridChanged(grid, oldGrid) {
		...
		if (this.dataProvider) this.__dataProviderChanged(this.dataProvider);
		if (this.editedItem) this.__editedItemChanged(this.editedItem);
	...
	*/
	__formChanged(form, oldForm) {
		...
		if (!form) return;
		if (this.items) this.__itemsChanged(this.items);
		if (this.editedItem) this.__editedItemChanged(this.editedItem);
	...
	*/
	__formPropsChanged(form, theme, include, exclude) {
		if (form) {
			...
			if (theme) form.setAttribute("theme", theme);
			else form.removeAttribute("theme");
		}
	}
	/**
	...
	*/
	__gridPropsChanged(grid, theme, include, exclude, noFilter, noHead, noSort, items) {
		...
		if (grid === this._gridController.defaultNode) {
			...
			if (theme) grid.setAttribute("theme", theme);
	...
	*/
	__saveButtonPropsChanged(saveButton, effectiveI18n, isDirty) {
		if (saveButton) {
			...
			if (saveButton === this._saveButtonController.defaultNode) saveButton.textContent = effectiveI18n.saveItem;
		}
	}
	/**
	...
	*/
	__deleteButtonPropsChanged(deleteButton, effectiveI18n, isNew) {
		if (deleteButton) {
			...
			if (deleteButton === this._deleteButtonController.defaultNode) deleteButton.textContent = effectiveI18n.deleteItem;
		}
	}
	/**
	...
	*/
	__cancelButtonPropsChanged(cancelButton, effectiveI18n) {
		if (cancelButton && cancelButton === this._cancelButtonController.defaultNode) cancelButton.textContent = effectiveI18n.cancel;
	}
	/**
	...
	*/
	__newButtonPropsChanged(newButton, effectiveI18n) {
		if (newButton && newButton === this._newButtonController.defaultNode) newButton.textContent = effectiveI18n.newItem;
	}
	/** @private */
	__dataProviderChanged(dataProvider) {
		if (this._grid) this._grid.dataProvider = this.__createDataProviderProxy(dataProvider);
	}
	/** @private */
	__editOnClickChanged(editOnClick, grid) {
		if (!grid) return;
		grid.hideEditColumn = editOnClick;
		if (editOnClick) grid.addEventListener("active-item-changed", this.__onGridActiveItemChanged);
		else grid.removeEventListener("active-item-changed", this.__onGridActiveItemChanged);
	}
	/** @private */
	__onGridActiveItemChanged(event) {
		...
		if (item) this.__edit(item);
		else if (!this.__keepOpened) this.__closeEditor();
	}
	/** @private */
	...
	__createDataProviderProxy(dataProvider) {
		return (params, callback) => {
			const callbackProxy = (chunk, size) => {
				if (chunk?.[0]) this.__model = chunk[0];
				callback(chunk, size);
			};
	...
	__itemsChanged(items) {
		if (this.items && this.items[0]) this.__model = items[0];
	}
	/** @private */
	__editedItemChanged(item) {
		if (!this._form) return;
		if (item) {
			if (!this._fields.length && this._form._configure) if (this.__model) this._form._configure(this.__model);
			else console.warn("<vaadin-crud> Unable to autoconfigure form because the data structure is unknown. Either specify `include` or ensure at least one item is available beforehand.");
			this._form.item = item;
			this._fields.forEach((e) => {
				const path = e.path || e.getAttribute("path");
				if (path) e.value = getProperty(path, item);
			});
	...
	__setHighlightedItem(item) {
		if (this._grid === this._gridController.defaultNode) this._grid.selectedItems = item ? [item] : [];
	}
	/** @private */
	__closeEditor() {
	...
	/** @private */
	__edit(item) {
		if (this.editedItem === item) return;
	...
	__openEditor(item) {
		...
		this.__isDirty = false;
		this.__isNew = !item;
		if (this.__fireEvent(this.__isNew ? "new" : "edit", item)) this.editedItem = item || {};
		else this.editorOpened = true;
	}
	/** @private */
	__restoreFocusOnDelete() {
		if (this._grid._flatSize === 1) this._newButton.focus();
		else this._grid._focusFirstVisibleRow();
	}
	/** @private */
	__restoreFocusOnSaveOrCancel() {
		...
		if (this._grid._isItemAssignedToRow(this.editedItem, row) && this._grid._isInViewport(row)) this.__focusRestorationController.restoreFocus();
		else this._grid._focusFirstVisibleRow();
	}
	/** @private */
	__save() {
		...
		this._fields.forEach((e) => {
			const path = e.path || e.getAttribute("path");
			if (path) setProperty(path, e.value, item);
		});
		if (this.__fireEvent("save", item)) {
			if (this.__isNew && !this.dataProvider) if (!this.items) this.items = [item];
	...
	/** @private */
	__cancel() {
		if (this.__isDirty) this._confirmCancelDialog.opened = true;
		else this.__confirmCancel();
	}
	/** @private */
	__confirmCancel() {
		if (this.__fireEvent("cancel", this.editedItem)) {
			this.__restoreFocusOnSaveOrCancel();
			this.__closeEditor();
		}
	}
	...
	/** @private */
	__confirmDelete() {
		if (this.__fireEvent("delete", this.editedItem)) {
			if (this.items && this.items.indexOf(this.editedItem) >= 0) this.items.splice(this.items.indexOf(this.editedItem), 1);
...
//#endregion
//#region node_modules/@vaadin/crud/src/vaadin-crud.js
/**
* @license
* Copyright (c) 2000 - 2026 Vaadin Ltd.
*
