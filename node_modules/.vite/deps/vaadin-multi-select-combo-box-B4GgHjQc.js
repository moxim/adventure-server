...
import { t as itemStyles } from "./vaadin-item-base-styles-t2m51Q3F.js";
...
import { ComboBoxPlaceholder } from "./@vaadin_combo-box_src_vaadin-combo-box-placeholder__js.js";
import { n as InputContainer, t as inputFieldShared } from "./input-field-shared-styles-CTATZMFP.js";
import { a as ComboBoxItemMixin, i as ComboBoxOverlayMixin, n as ComboBoxScrollerMixin, o as comboBoxItemStyles, r as comboBoxScrollerStyles } from "./vaadin-combo-box-base-mixin-BFt35TfB.js";
import { a as comboBoxOverlayStyles, i as comboBoxStyles, n as ComboBoxFocusIndexMixin, r as ComboBoxDataProviderMixin, t as ComboBoxItemsMixin } from "./vaadin-combo-box-items-mixin-BDfdCuiU.js";
import { t as InputControlMixin } from "./input-control-mixin-CHzREIdf.js";
//#region node_modules/@vaadin/multi-select-combo-box/src/styles/vaadin-multi-select-combo-box-chip-base-styles.js
/**
* @license
...
`;
//#endregion
//#region node_modules/@vaadin/multi-select-combo-box/src/vaadin-multi-select-combo-box-chip.js
/**
* @license
* Copyright (c) 2021 - 2026 Vaadin Ltd.
* This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
...
//#endregion
//#region node_modules/@vaadin/multi-select-combo-box/src/vaadin-multi-select-combo-box-container.js
/**
* @license
* Copyright (c) 2021 - 2026 Vaadin Ltd.
* This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
...
//#endregion
//#region node_modules/@vaadin/multi-select-combo-box/src/vaadin-multi-select-combo-box-item.js
/**
* @license
* Copyright (c) 2021 - 2026 Vaadin Ltd.
* This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
...
* @private
*/
var MultiSelectComboBoxItem = class extends ComboBoxItemMixin(ThemableMixin(DirMixin(PolylitMixin(LumoInjectionMixin(LitElement))))) {
	static get is() {
...
//#endregion
//#region node_modules/@vaadin/multi-select-combo-box/src/styles/vaadin-multi-select-combo-box-overlay-base-styles.js
/**
* @license
* Copyright (c) 2021 - 2026 Vaadin Ltd.
* This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
*/
var multiSelectComboBoxOverlayStyles = [comboBoxOverlayStyles, css`
    #overlay {
      width: var(
  ...
  `];
//#endregion
//#region node_modules/@vaadin/multi-select-combo-box/src/vaadin-multi-select-combo-box-overlay.js
/**
* @license
* Copyright (c) 2021 - 2026 Vaadin Ltd.
* This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
...
* @private
*/
var MultiSelectComboBoxOverlay = class extends ComboBoxOverlayMixin(OverlayMixin(DirMixin(ThemableMixin(PolylitMixin(LumoInjectionMixin(LitElement)))))) {
	static get is() {
...
//#endregion
//#region node_modules/@vaadin/multi-select-combo-box/src/styles/vaadin-multi-select-combo-box-scroller-base-styles.js
/**
* @license
* Copyright (c) 2021 - 2026 Vaadin Ltd.
* This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
...
//#endregion
//#region node_modules/@vaadin/multi-select-combo-box/src/vaadin-multi-select-combo-box-scroller.js
/**
* @license
* Copyright (c) 2021 - 2026 Vaadin Ltd.
* This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
...
var MultiSelectComboBoxScroller = class extends ComboBoxScrollerMixin(PolylitMixin(LitElement)) {
	...
	*/
	_isItemSelected(item, _selectedItem, itemIdPath) {
		if (item instanceof ComboBoxPlaceholder) return false;
...
//#endregion
//#region node_modules/@vaadin/multi-select-combo-box/src/styles/vaadin-multi-select-combo-box-base-styles.js
/**
* @license
* Copyright (c) 2021 - 2026 Vaadin Ltd.
* This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
*/
var multiSelectComboBoxStyles = [comboBoxStyles, css`
    :host {
      max-width: 100%;
  ...
  `];
//#endregion
//#region node_modules/@vaadin/multi-select-combo-box/src/vaadin-multi-select-combo-box-mixin.js
/**
* @license
* Copyright (c) 2021 - 2026 Vaadin Ltd.
* This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
...
var MultiSelectComboBoxMixin = (superClass) => class MultiSelectComboBoxMixinClass extends I18nMixin(ComboBoxFocusIndexMixin(ComboBoxDataProviderMixin(ComboBoxItemsMixin(InputControlMixin(ResizeMixin(superClass)))))) {
	static get properties() {
		return {
			/**
	...
	*/
	...
	ready() {
		...
		this._overflowController = new SlotController(this, "overflow", "vaadin-multi-select-combo-box-chip", { initializer: (chip) => {
	...
	updated(props) {
		...
		[
			...
			if (props.has(prop)) this._scroller[prop] = this[prop];
		});
		if (props.has("selectedItems") && this.opened) this.$.overlay._updateOverlayWidth();
		if ([
			"autoExpandHorizontally",
			"autoExpandVertically",
			"collapseChips",
			...
			"clearButtonVisible",
			"itemClassNameGenerator"
		].some((prop) => props.has(prop))) this.__updateChips();
		if (props.has("readonly")) {
			this._setDropdownItems(this.filteredItems);
			if (this.dataProvider) this.clearCache();
		}
	}
	/**
	...
	*/
	open() {
		if (!this.disabled && !(this.readonly && this.selectedItems.length === 0)) this.opened = true;
	}
	/**
	...
	*/
	_onClosed() {
		...
		if (!this.loading || this.allowCustomValue) this._commitValue();
	}
	/** @private */
	__updateScroller(opened, items, focusedIndex, theme) {
		if (opened) this._scroller.style.maxHeight = getComputedStyle(this).getPropertyValue(`--${this._tagNamePrefix}-overlay-max-height`) || "65vh";
	...
	*/
	_closeOrCommit() {
		if (!this.opened) this._commitValue();
		else this.close();
	}
	/**
	* @protected
	...
	*/
	_commitValue() {
		...
		} else this.__commitUserInput();
		if (!this.keepFilter || !this.opened) this.filter = "";
	}
	/** @private */
	__commitUserInput() {
		if (this._focusedIndex > -1) {
			...
			} else if (!this.allowCustomValue && !this.opened && itemMatchingInputValue) this.__selectItem(itemMatchingInputValue);
			else this._inputElementValue = "";
		}
	}
	/**
	...
	*/
	_setFocused(focused) {
		if (!focused) this._ignoreCommitValue = true;
		super._setFocused(focused);
		if (!focused && document.hasFocus()) {
			this._focusedChipIndex = -1;
			this._requestValidation();
		}
		if (!focused && this.readonly && !this._closeOnBlurIsPrevented) this.close();
	}
	/**
	...
	*/
	...
	_placeholderChanged(placeholder) {
		...
		if (tmpPlaceholder !== placeholder) {
			...
			if (tmpPlaceholder) this.placeholder = tmpPlaceholder;
		}
	}
	/** @private */
	_selectedItemsChanged(selectedItems) {
		...
		if (this._hasValue) {
			...
			if (this.__tmpA11yPlaceholder === void 0) this.__savedPlaceholder = this.placeholder;
	...
	_topGroupChanged(topGroup) {
		if (topGroup) this._setDropdownItems(this.filteredItems);
	}
	/**
	...
	*/
	...
	__setDropdownItems(newItems) {
		...
		if (oldItems && oldItems[this._focusedIndex] instanceof ComboBoxPlaceholder && newItems[this._focusedIndex] instanceof ComboBoxPlaceholder) return;
		const focusedItemIndex = this.__getItemIndexByValue(newItems, this._getItemValue(focusedItem));
		if (focusedItemIndex > -1) this._focusedIndex = focusedItemIndex;
		else this._focusedIndex = this.__getItemIndexByLabel(newItems, this.filter);
	}
	/** @private */
	...
	_findIndex(item, selectedItems, itemIdPath) {
		if (itemIdPath && item) {
			for (let index = 0; index < selectedItems.length; index++) if (selectedItems[index] && selectedItems[index][itemIdPath] === item[itemIdPath]) return index;
			return -1;
		}
	...
	*/
	__clearInternalValue(force = false) {
		if (!this.keepFilter || force) {
			this.filter = "";
			this._inputElementValue = "";
		} else this._inputElementValue = this.filter;
	}
	/** @private */
	...
	__selectItem(item) {
		...
		if (index !== -1) {
			if (this._lastFilter?.toLowerCase() === itemLabel.toLowerCase()) {
	...
	/** @private */
	__updateTopGroup(selectedItemsOnTop, selectedItems, opened) {
		if (!selectedItemsOnTop) this._topGroup = [];
		else if (!opened || this.__needToSyncTopGroup()) this._topGroup = [...selectedItems];
	}
	/** @private */
	__needToSyncTopGroup() {
		if (!this.itemIdPath) return false;
	...
	__createChip(item) {
		...
		if (typeof this.itemClassNameGenerator === "function") chip.className = this.itemClassNameGenerator(item);
	...
	/** @private */
	__updateChips() {
		if (!this._inputField || !this.inputElement) return;
		...
		if (this.collapseChips) this._overflowItems = this.__updateChipsCollapsed(this.selectedItems, inputWidth);
		else if (this.autoExpandHorizontally) this._overflowItems = this.__updateChipsHorizontalExpand(this.selectedItems, inputWidth);
		else this._overflowItems = this.__updateChipsDefault(this.selectedItems, inputWidth);
	}
	/** @private */
	...
	__updateChipsHorizontalExpand(items, inputWidth) {
		...
		while (visibleCount > 1) {
			...
			if (this.__getWrapperWidth() - this.$.chips.clientWidth >= inputWidth + overflowWidth) break;
		}
		if (visibleCount === 1) {
	...
	__updateChipsDefault(items, inputWidth) {
		...
		if (items.length > 1) remainingWidth -= this.__getOverflowWidth();
		const chipMinWidth = parseInt(getComputedStyle(this).getPropertyValue("--_chip-min-width"));
	...
	*/
	_onArrowDown() {
		if (!this.readonly) super._onArrowDown();
	...
	*/
	_onArrowUp() {
		if (!this.readonly) super._onArrowUp();
		else if (!this.opened) this.open();
	}
	/**
	* Override an event listener from `KeyboardMixin`.
	...
	*/
	_onKeyDown(event) {
		...
		if (!this.readonly && chips.length > 0) switch (event.key) {
			case "Backspace":
	...
	_onArrowLeft(chips, event) {
		if (this.inputElement.selectionStart !== 0) return;
		const idx = this._focusedChipIndex;
		if (idx !== -1) event.preventDefault();
		let newIdx;
		if (!this.__isRTL) {
			if (idx === -1) newIdx = chips.length - 1;
			else if (idx > 0) newIdx = idx - 1;
		} else if (idx === chips.length - 1) newIdx = -1;
		else if (idx > -1) newIdx = idx + 1;
		if (newIdx !== void 0) this._focusedChipIndex = newIdx;
	}
	/** @private */
	...
	_onBackSpace(chips) {
		if (this.inputElement.selectionStart !== 0) return;
		const idx = this._focusedChipIndex;
		if (idx === -1) this._focusedChipIndex = chips.length - 1;
		else {
	...
	_focusedChipIndexChanged(focusedIndex, oldFocusedIndex) {
		if (focusedIndex > -1 || oldFocusedIndex > -1) {
			...
			if (focusedIndex > -1) {
				...
				announce(`${this._getItemLabel(item)} ${this.__effectiveI18n.focused}`);
			}
		}
	}
	/**
	...
	*/
	_overlaySelectedItemChanged(event) {
		event.stopPropagation();
		if (this.readonly) return;
		if (event.detail.item instanceof ComboBoxPlaceholder) return;
		if (this.opened) {
...
//#endregion
//#region node_modules/@vaadin/multi-select-combo-box/src/vaadin-multi-select-combo-box.js
/**
* @license
* Copyright (c) 2021 - 2026 Vaadin Ltd.
* This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
...
* @extends HTMLElement
*/
var MultiSelectComboBox = class extends MultiSelectComboBoxMixin(ThemableMixin(ElementMixin(PolylitMixin(LumoInjectionMixin(LitElement))))) {
	static get is() {
		return "vaadin-multi-select-combo-box";
	}
	static get styles() {
...
//# sourceMappingURL=vaadin-multi-select-combo-box-B4GgHjQc.js.map