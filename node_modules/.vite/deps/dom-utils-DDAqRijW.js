//#region node_modules/@vaadin/component-base/src/dom-utils.js
/**
* @license
...
function getFlattenedElements(node) {
	const result = [];
	let elements;
	if (node.localName === "slot") elements = node.assignedElements();
	else {
		result.push(node);
...
//#endregion
export { getFlattenedElements as a, serializeAttributeValue as c, getClosestElement as i, deserializeAttributeValue as n, isEmptyTextNode as o, getAncestorRootNodes as r, removeValueFromAttribute as s, addValueToAttribute as t };

//# sourceMappingURL=dom-utils-DDAqRijW.js.map