import { m as EventType_default, n as getUid } from "./util-CuJ0gt1B.js";
import { d as createEmpty, i as buffer, k as getCenter, m as createOrUpdateFromCoordinate } from "./extent-DmAah91Y.js";
import { B as add, U as scale } from "./proj-R0q3-kiO.js";
import { t as assert } from "./asserts-CxKOIJBj.js";
import Point from "./ol_geom_Point.js";
import Feature from "./ol_Feature.js";
import { t as VectorSource } from "./Vector-DgqUZubA.js";
//#region node_modules/ol/source/Cluster.js
/**
...
*/
var Cluster = class extends VectorSource {
	/**
	...
	*/
	setSource(source) {
		if (this.source) this.source.removeEventListener(EventType_default.CHANGE, this.boundRefresh_);
		this.source = source;
		if (source) source.addEventListener(EventType_default.CHANGE, this.boundRefresh_);
		this.refresh();
	}
	/**
	...
	*/
	createCluster(features, extent) {
		...
		for (let i = features.length - 1; i >= 0; --i) {
			...
			if (geometry) add(centroid, geometry.getCoordinates());
