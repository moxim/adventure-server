...
//#region node_modules/@vaadin/item/src/vaadin-item-mixin.js
/**
* @license
...
var ItemMixin = (superClass) => class VaadinItemMixin extends ActiveMixin(FocusMixin(superClass)) {
	static get properties() {
		return {
			...
			*/
			_hasVaadinItemMixin: { value: true },
			/**
	...
	*/
	...
	ready() {
		...
		if (this.__shouldAllowFocusWhenDisabled()) this.style.setProperty("--_vaadin-item-disabled-pointer-events", "auto");
	}
	/**
	...
	*/
	focus(options) {
		if (this.disabled && !this.__shouldAllowFocusWhenDisabled()) return;
		super.focus(options);
	}
	/**
	...
	*/
	_disabledChanged(disabled) {
		...
		if (disabled) {
			this.selected = false;
			if (!this.__shouldAllowFocusWhenDisabled()) this.blur();
		}
	}
	/**
...
//#endregion
export { ItemMixin as t };

//# sourceMappingURL=vaadin-item-mixin-3ujT0Lyg.js.map