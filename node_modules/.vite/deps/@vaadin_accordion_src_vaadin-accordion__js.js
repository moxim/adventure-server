...
import "./vaadin-accordion-panel-ymhO0wOZ.js";
...
//#region node_modules/@vaadin/accordion/src/vaadin-accordion-mixin.js
/**
* @license
...
var AccordionMixin = (superClass) => class AccordionMixinClass extends KeyboardDirectionMixin(superClass) {
	...
	*/
	focus(options) {
		if (this._observer) this._observer.flush();
		super.focus(options);
	}
	/** @protected */
	ready() {
	...
	*/
	_onKeyDown(event) {
		if (!this.items.some((item) => item.focusElement === event.target)) return;
		super._onKeyDown(event);
	}
	/** @private */
	_updateOpened(e) {
		if (this.__itemsSync) return;
		const target = this._filterItems(e.composedPath())[0];
		const idx = this.items.indexOf(target);
		if (e.detail.value) {
			if (target.disabled || idx === -1) return;
			this.opened = idx;
		} else if (!this.items.some((item) => item.opened)) this.opened = null;
	}
};
//#endregion
//#region node_modules/@vaadin/accordion/src/vaadin-accordion.js
/**
* @license
* Copyright (c) 2019 - 2026 Vaadin Ltd.
* This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
...
* @extends HTMLElement
*/
var Accordion = class extends AccordionMixin(ThemableMixin(ElementMixin(PolylitMixin(LitElement)))) {
	static get is() {
...
//# sourceMappingURL=@vaadin_accordion_src_vaadin-accordion__js.js.map