import { d as createEmpty, i as buffer } from "./extent-DmAah91Y.js";
import { a as modulo } from "./math-CMFMV3TR.js";
import { A as transform, G as compareVersions, y as get } from "./proj-R0q3-kiO.js";
import { c as calculateSourceResolution, r as hash } from "./tilecoord-C9I_GQrp.js";
import { i as getImageSrc, o as getRequestParams, t as DEFAULT_VERSION } from "./wms-CqlG-P2v.js";
import { t as appendParams } from "./uri-BEPN43K0.js";
import { t as TileImage } from "./TileImage-D69rj93Q.js";
//#region node_modules/ol/source/TileWMS.js
/**
...
* @api
*/
var TileWMS = class extends TileImage {
	/**
	...
	*/
	getFeatureInfoUrl(coordinate, resolution, projection, params) {
		...
		if (tileGrid.getResolutions().length <= tileCoord[0]) return;
		let tileExtent = tileGrid.getTileCoordExtent(tileCoord, this.tmpExtent_);
		const gutter = this.gutter_;
		if (gutter !== 0) tileExtent = buffer(tileExtent, tileResolution * gutter, tileExtent);
		const baseParams = { "QUERY_LAYERS": this.params_["LAYERS"] };
	...
	*/
	getLegendUrl(resolution, params) {
		...
		if (resolution !== void 0) baseParams["SCALE"] = resolution * (this.getProjection() ? this.getProjection().getMetersPerUnit() : 1) / 28e-5;
	...
	*/
	getRequestUrl_(tileCoord, tileExtent, pixelRatio, projection, params) {
		...
		else url = urls[modulo(hash(tileCoord), urls.length)];
	...
	*/
	updateV13_() {
		const version = this.params_["VERSION"] || "1.3.0";
	...
	*/
	tileUrlFunction(tileCoord, pixelRatio, projection) {
		...
		if (tileGrid.getResolutions().length <= tileCoord[0]) return;
		if (pixelRatio != 1 && (!this.hidpi_ || this.serverType_ === void 0)) pixelRatio = 1;
