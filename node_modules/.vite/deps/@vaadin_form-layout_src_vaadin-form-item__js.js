...
import { t as issueWarning } from "./warnings-C9_oP_c0.js";
...
//#region node_modules/@vaadin/form-layout/src/styles/vaadin-form-item-base-styles.js
/**
* @license
...
`;
//#endregion
//#region node_modules/@vaadin/form-layout/src/vaadin-form-item-mixin.js
/**
* @license
...
var FormItemMixin = (superClass) => class extends superClass {
	...
	*/
	__onLabelSlotChange() {
		if (this.__labelNode) {
			this.__labelNode = null;
			if (this.__fieldNode) this.__unlinkLabelFromField(this.__fieldNode);
		}
		const newLabelNode = this.$.labelSlot.assignedElements()[0];
		if (newLabelNode) {
			this.__labelNode = newLabelNode;
			if (this.__labelNode.id) this.__labelId = this.__labelNode.id;
			else {
				this.__labelId = `label-${this.localName}-${generateUniqueId()}`;
				this.__labelNode.id = this.__labelId;
			}
			if (this.__fieldNode) this.__linkLabelToField(this.__fieldNode);
		}
	}
	/**
	...
	*/
	__onContentSlotChange() {
		...
		if (fieldNodes.length > 1) issueWarning(`WARNING: Since Vaadin 23, placing multiple fields directly to a <vaadin-form-item> is deprecated.
Please wrap fields with a <vaadin-custom-field> instead.`);
		...
		if (newFieldNode) {
			...
			if (this.__labelNode) this.__linkLabelToField(this.__fieldNode);
		}
	...
	__synchronizeAttributes() {
		...
		this.toggleAttribute("invalid", field.hasAttribute("invalid") || field.matches(":invalid") && this.__isFieldDirty);
	}
};
//#endregion
//#region node_modules/@vaadin/form-layout/src/vaadin-form-item.js
/**
* @license
* Copyright (c) 2017 - 2026 Vaadin Ltd.
* This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
