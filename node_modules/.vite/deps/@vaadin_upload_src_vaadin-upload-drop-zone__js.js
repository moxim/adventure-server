...
//#region node_modules/@vaadin/upload/src/styles/vaadin-upload-drop-zone-base-styles.js
/**
* @license
* Copyright (c) 2000 - 2026 Vaadin Ltd.
* This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
*/
var uploadDropZoneStyles = css`
  :host {
    display: block;
    position: relative;
  }
...
`;
//#endregion
//#region node_modules/@vaadin/upload/src/vaadin-upload-drop-zone.js
/**
* @license
* Copyright (c) 2000 - 2026 Vaadin Ltd.
* This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
...
* @extends HTMLElement
*/
var UploadDropZone = class extends ElementMixin(ThemableMixin(PolylitMixin(LumoInjectionMixin(LitElement)))) {
	static get is() {
	...
	*/
	...
	__onDragover(event) {
		...
		if (!this.__effectiveDisabled) this.__dragover = true;
	...
	__managerChanged(manager, oldManager) {
		...
		if (this.isConnected) this.__syncDisabledState();
	}
	/** @private */
...
//# sourceMappingURL=@vaadin_upload_src_vaadin-upload-drop-zone__js.js.map