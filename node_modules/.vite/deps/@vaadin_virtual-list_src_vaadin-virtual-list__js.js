...
import { isChrome, isSafari } from "./@vaadin_component-base_src_browser-utils__js.js";
import { t as Virtualizer } from "./virtualizer-DLVbY-3F.js";
import { t as OverflowController } from "./overflow-controller-B1O3h4Je.js";
//#region node_modules/@vaadin/virtual-list/src/styles/vaadin-virtual-list-base-styles.js
/**
* @license
...
`;
//#endregion
//#region node_modules/@vaadin/virtual-list/src/vaadin-virtual-list-mixin.js
/**
* @license
* Copyright (c) 2021 - 2026 Vaadin Ltd.
* This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
...
var VirtualListMixin = (superClass) => class VirtualListMixinClass extends superClass {
	...
	*/
	...
	__updateElement(el, index) {
		...
		if (this.renderer) this.renderer(el, this, {
			item,
			index
		});
	}
	...
	*/
	__onDocumentDragStart(e) {
		if (e.target.contains(this)) {
			...
			if (this.scrollHeight > 2e4) this.$.items.style.display = "none";
			if (isChrome) e.target.style.willChange = "transform";
			if (isSafari) this.$.items.style.maxHeight = "100%";
	...
	*/
	requestContentUpdate() {
		if (this.__virtualizer) this.__virtualizer.update();
	}
};
//#endregion
//#region node_modules/@vaadin/virtual-list/src/vaadin-virtual-list.js
/**
* @license
* Copyright (c) 2021 - 2026 Vaadin Ltd.
* This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
