...
import { t as buttonStyles } from "./vaadin-button-base-styles-BIQHXyYX.js";
import { t as ButtonMixin } from "./vaadin-button-mixin-H5Q-QvXp.js";
import "./vaadin-text-area-B5pNcwP_.js";
//#region node_modules/@vaadin/message-input/src/styles/vaadin-message-input-button-styles.js
/**
* @license
* Copyright (c) 2021 - 2026 Vaadin Ltd.
* This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
*/
var messageInputButtonStyles = css`
  :host {
    flex: none;
    align-self: end;
    margin: var(
...
`;
//#endregion
//#region node_modules/@vaadin/message-input/src/vaadin-message-input-button.js
/**
* @license
* Copyright (c) 2021 - 2026 Vaadin Ltd.
* This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
...
* @private
*/
var MessageInputButton = class extends ButtonMixin(DirMixin(ThemableMixin(PolylitMixin(LumoInjectionMixin(LitElement))))) {
	static get is() {
...
//#endregion
//#region node_modules/@vaadin/message-input/src/styles/vaadin-message-input-base-styles.js
/**
* @license
* Copyright (c) 2021 - 2026 Vaadin Ltd.
* This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
*/
var messageInputStyles = css`
  :host {
...
`;
//#endregion
//#region node_modules/@vaadin/message-input/src/vaadin-message-input-mixin.js
/**
* @license
* Copyright (c) 2021 - 2026 Vaadin Ltd.
* This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
...
var MessageInputMixin = (superClass) => class MessageInputMixinClass extends I18nMixin(superClass) {
	...
	static get observers() {
		return ["__buttonPropsChanged(_button, disabled, __effectiveI18n, value)", "__textAreaPropsChanged(_textArea, disabled, __effectiveI18n, value)"];
	}
	...
	*/
	...
	ready() {
		super.ready();
		this._buttonController = new SlotController(this, "button", "vaadin-message-input-button", { initializer: (btn) => {
		...
		this._textAreaController = new SlotController(this, "textarea", "vaadin-text-area", { initializer: (textarea) => {
	...
	focus(options) {
		if (this._textArea) this._textArea.focus(options);
	}
	/** @private */
...
//#endregion
//#region node_modules/@vaadin/message-input/src/vaadin-message-input.js
/**
* @license
* Copyright (c) 2021 - 2026 Vaadin Ltd.
* This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
...
* @extends HTMLElement
*/
var MessageInput = class extends MessageInputMixin(ElementMixin(ThemableMixin(PolylitMixin(LumoInjectionMixin(LitElement))))) {
	static get is() {
...
//# sourceMappingURL=@vaadin_message-input_src_vaadin-message-input__js.js.map