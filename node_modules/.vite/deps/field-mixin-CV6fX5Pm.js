import { i as dedupeMixin } from "./polylit-mixin-BwU08z1T.js";
...
import { t as LabelMixin } from "./label-mixin-BN3X4xkJ.js";
import { n as restoreGeneratedAriaIDReference, r as setAriaIDReference, t as removeAriaIDReference } from "./aria-id-reference-CQM55Xif.js";
//#region node_modules/@vaadin/a11y-base/src/field-aria-controller.js
/**
* @license
...
var FieldAriaController = class {
	...
	*/
	setTarget(target) {
		...
		if (this.__labelIdFromUser != null) this.__setLabelIdToAriaAttribute(this.__labelIdFromUser, this.__labelIdFromUser, true);
	...
	*/
	setLabelId(labelId, fromUser = false) {
		...
		if (fromUser) this.__labelIdFromUser = labelId;
		else this.__labelId = labelId;
	}
	/**
	...
	*/
	__setAriaRequiredAttribute(required) {
		if (!this.__target) return;
		if (["input", "textarea"].includes(this.__target.localName)) return;
		if (required) this.__target.setAttribute("aria-required", "true");
		else this.__target.removeAttribute("aria-required");
	}
};
//#endregion
//#region node_modules/@vaadin/field-base/src/error-controller.js
/**
* @license
* Copyright (c) 2021 - 2026 Vaadin Ltd.
* This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
...
var ErrorController = class extends SlotChildObserveController {
	...
	*/
	initAddedNode(node) {
		if (node !== this.defaultNode) this.initCustomNode(node);
	}
	/**
	...
	*/
	updateDefaultNode(errorNode) {
		...
		if (errorNode) {
			...
			if (hasError) announce(errorMessage, { mode: "assertive" });
		}
		super.updateDefaultNode(errorNode);
	}
};
//#endregion
//#region node_modules/@vaadin/field-base/src/helper-controller.js
/**
* @license
* Copyright (c) 2021 - 2026 Vaadin Ltd.
* This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
...
var HelperController = class extends SlotChildObserveController {
	...
	*/
	updateDefaultNode(node) {
		if (node) node.textContent = this.helperText;
...
//#endregion
//#region node_modules/@vaadin/field-base/src/validate-mixin.js
/**
* @license
* Copyright (c) 2021 - 2026 Vaadin Ltd.
* This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
...
*/
var ValidateMixinImplementation = (superclass) => class extends superclass {
	...
	*/
	_setInvalid(invalid) {
		if (this._shouldSetInvalid(invalid)) this.invalid = invalid;
	}
	/**
	...
	*/
	...
	/** @protected */
	_requestValidation() {
		if (!this.manualValidation) this.validate();
	}
};
var ValidateMixin = dedupeMixin(ValidateMixinImplementation);
//#endregion
//#region node_modules/@vaadin/field-base/src/field-mixin.js
/**
* @license
* Copyright (c) 2021 - 2026 Vaadin Ltd.
* This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
...
//#endregion
export { ValidateMixin as n, FieldMixin as t };

//# sourceMappingURL=field-mixin-CV6fX5Pm.js.map