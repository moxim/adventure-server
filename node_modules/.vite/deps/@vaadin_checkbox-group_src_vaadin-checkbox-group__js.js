...
import "./vaadin-checkbox-CD8g5iNv.js";
import { t as FieldMixin } from "./field-mixin-CV6fX5Pm.js";
import { t as group } from "./group-base-styles-BydGvePB.js";
//#region node_modules/@vaadin/checkbox-group/src/styles/vaadin-checkbox-group-base-styles.js
/**
* @license
...
//#endregion
//#region node_modules/@vaadin/checkbox-group/src/vaadin-checkbox-group-mixin.js
/**
* @license
* Copyright (c) 2018 - 2026 Vaadin Ltd.
* This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
...
var CheckboxGroupMixin = (superclass) => class CheckboxGroupMixinClass extends FieldMixin(FocusMixin(DisabledMixin(superclass))) {
	...
	constructor() {
		...
		this._tooltipController.addEventListener("tooltip-changed", (event) => {
			if (event.detail.node?.isConnected) {
				const inputs = this.__checkboxes.map((checkbox) => checkbox.inputElement);
				this._tooltipController.setAriaTarget(inputs);
			} else this._tooltipController.setAriaTarget([]);
		});
	}
	/**
	...
	*/
	__registerCheckbox(checkbox) {
		...
		if (this.readonly) checkbox.readonly = true;
		if (checkbox.checked) this.__addCheckboxToValue(checkbox.value);
		else if (this.value && this.value.includes(checkbox.value)) checkbox.checked = true;
	}
	/**
	...
	*/
	__unregisterCheckbox(checkbox) {
		...
		if (checkbox.checked) this.__removeCheckboxFromValue(checkbox.value);
	}
	/**
	...
	*/
	_disabledChanged(newValue, oldValue) {
		...
		if (oldValue !== newValue) this.__checkboxes.forEach((checkbox) => {
	...
	*/
	__addCheckboxToValue(value) {
		...
		else if (!this.value.includes(value)) this.value = [...this.value, value];
	}
	/**
	* @param {string} value
	* @private
	*/
	__removeCheckboxFromValue(value) {
		if (this.value && this.value.includes(value)) this.value = this.value.filter((v) => v !== value);
	}
	/**
	...
	*/
	__onCheckboxCheckedChanged(event) {
		...
		if (checkbox.checked) this.__addCheckboxToValue(checkbox.value);
		else this.__removeCheckboxFromValue(checkbox.value);
	}
	/**
	...
	*/
	__valueChanged(value, oldValue) {
		if (value?.length === 0 && oldValue === void 0) return;
	...
	__readonlyChanged(readonly, oldReadonly) {
		if (readonly || oldReadonly) this.__checkboxes.forEach((checkbox) => {
...
//#endregion
//#region node_modules/@vaadin/checkbox-group/src/vaadin-checkbox-group.js
/**
* @license
* Copyright (c) 2018 - 2026 Vaadin Ltd.
* This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
...
* @extends HTMLElement
*/
var CheckboxGroup = class extends CheckboxGroupMixin(ElementMixin(ThemableMixin(PolylitMixin(LumoInjectionMixin(LitElement))))) {
	static get is() {
