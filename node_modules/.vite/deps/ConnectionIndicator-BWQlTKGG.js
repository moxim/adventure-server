...
import { t as classMap } from "./class-map-CIDY8VVJ.js";
import { c as property, s as state } from "./decorators-B1oyJKkh.js";
//#region node_modules/@vaadin/common-frontend/ConnectionState.js
...
var ConnectionStateStore = class {
	...
	loadingFinished() {
		this.#decreaseLoadingCount("connected");
	}
	loadingFailed() {
		this.#decreaseLoadingCount("connection-lost");
	}
	#decreaseLoadingCount(finalState) {
		if (this.#loadingCount > 0) {
			this.#loadingCount -= 1;
			if (this.#loadingCount === 0) this.state = finalState;
		}
	}
	get state() {
	...
	set state(newState) {
		if (newState !== this.#connectionState) {
			...
			this.#loadingCount = 0;
			for (const listener of this.#stateChangeListeners) listener(prevState, this.#connectionState);
		}
	}
	get online() {
		return this.#connectionState === "connected" || this.#connectionState === "loading";
	}
	get offline() {
		return !this.online;
	}
	#serviceWorkerMessageListener = (event) => {
		if (typeof event.data === "object" && event.data.id === "Vaadin.ServiceWorker.isConnectionLost") {
			if (event.data.result === true) this.state = "connection-lost";
...
if (!$wnd.Vaadin?.connectionState) {
	let online;
	if (isLocalhost(window.location.hostname)) online = true;
	else online = navigator.onLine;
	$wnd.Vaadin ??= {};
	$wnd.Vaadin.connectionState = new ConnectionStateStore(online ? "connected" : "connection-lost");
}
//#endregion
//#region node_modules/@vaadin/common-frontend/ConnectionIndicator.js
...
var _ConnectionIndicator = class _ConnectionIndicator extends (_a = LitElement, _firstDelay_dec = [property({ type: Number })], _secondDelay_dec = [property({ type: Number })], _thirdDelay_dec = [property({ type: Number })], _expandedDuration_dec = [property({ type: Number })], _onlineText_dec = [property({ type: String })], _offlineText_dec = [property({ type: String })], _reconnectingText_dec = [property({ type: String })], _offline_dec = [property({
	type: Boolean,
	reflect: true
})], _reconnecting_dec = [property({
	type: Boolean,
	reflect: true
})], _expanded_dec = [property({
	type: Boolean,
	reflect: true
})], _loading_dec = [property({
	type: Boolean,
	reflect: true
})], _loadingBarState_dec = [state()], _applyDefaultTheme_dec = [property({
	type: Boolean,
	reflect: true
})], _a) {
	constructor() {
		...
		__privateAdd(this, _loadingBarState, __runInitializers(_init, 52, this, "")), __runInitializers(_init, 55, this);
	...
	*/
	...
	render() {
      ...
      <div
        class="v-status-message ${classMap({ active: this.reconnecting })}"
      >
	...
	disconnectedCallback() {
		...
		if (__privateGet(this, _connectionStateStore)) __privateGet(this, _connectionStateStore).removeStateChangeListener(this.connectionStateListener);
		__privateMethod(this, _ConnectionIndicator_instances, updateTheme_fn).call(this);
	...
	updated(props) {
		if ([
			...
			"reconnecting",
			"expanded"
		].some((p) => props.has(p))) __privateMethod(this, _ConnectionIndicator_instances, updatePopoverState_fn).call(this);
	}
...
_firstDelay = /* @__PURE__ */ new WeakMap();
_secondDelay = /* @__PURE__ */ new WeakMap();
_thirdDelay = /* @__PURE__ */ new WeakMap();
_expandedDuration = /* @__PURE__ */ new WeakMap();
_onlineText = /* @__PURE__ */ new WeakMap();
_offlineText = /* @__PURE__ */ new WeakMap();
_reconnectingText = /* @__PURE__ */ new WeakMap();
_offline = /* @__PURE__ */ new WeakMap();
_reconnecting = /* @__PURE__ */ new WeakMap();
_expanded = /* @__PURE__ */ new WeakMap();
_loading = /* @__PURE__ */ new WeakMap();
_loadingBarState = /* @__PURE__ */ new WeakMap();
_ConnectionIndicator_instances = /* @__PURE__ */ new WeakSet();
__isPopover = /* @__PURE__ */ new WeakMap();
...
_applyDefaultThemeState = /* @__PURE__ */ new WeakMap();
_firstTimeout = /* @__PURE__ */ new WeakMap();
_secondTimeout = /* @__PURE__ */ new WeakMap();
_thirdTimeout = /* @__PURE__ */ new WeakMap();
_expandedTimeout = /* @__PURE__ */ new WeakMap();
_connectionStateStore = /* @__PURE__ */ new WeakMap();
_lastMessageState = /* @__PURE__ */ new WeakMap();
...
updateLoading_fn = function(loading) {
	...
	__privateSet(this, _ConnectionIndicator_instances, "", loadingBarState_set);
	__privateSet(this, _firstTimeout, __privateMethod(this, _ConnectionIndicator_instances, timeoutFor_fn).call(this, __privateGet(this, _firstTimeout), loading, () => {
		__privateSet(this, _ConnectionIndicator_instances, "first", loadingBarState_set);
	}, this.firstDelay));
	__privateSet(this, _secondTimeout, __privateMethod(this, _ConnectionIndicator_instances, timeoutFor_fn).call(this, __privateGet(this, _secondTimeout), loading, () => {
		__privateSet(this, _ConnectionIndicator_instances, "second", loadingBarState_set);
	}, this.secondDelay));
	__privateSet(this, _thirdTimeout, __privateMethod(this, _ConnectionIndicator_instances, timeoutFor_fn).call(this, __privateGet(this, _thirdTimeout), loading, () => {
		__privateSet(this, _ConnectionIndicator_instances, "third", loadingBarState_set);
	}, this.thirdDelay));
};
updatePopoverState_fn = function() {
	const showPopover = this.loading || this.offline || this.reconnecting || this.expanded;
	if (__privateGet(this, _ConnectionIndicator_instances, isPopover_get)) this.hidePopover();
	if (showPopover) this.showPopover();
	__privateSet(this, _ConnectionIndicator_instances, showPopover, isPopover_set);
};
renderMessage_fn = function() {
	if (this.reconnecting) return this.reconnectingText;
	if (this.offline) return this.offlineText;
...
getLoadingBarStyle_fn = function() {
	switch (__privateGet(this, _ConnectionIndicator_instances, loadingBarState_get)) {
		case "": return "display: none";
		case "first":
		case "second":
		case "third": return "display: block";
		default: return "";
	}
};
...
var ConnectionIndicator = _ConnectionIndicator;
if (customElements.get("vaadin-connection-indicator") === void 0) customElements.define("vaadin-connection-indicator", ConnectionIndicator);
var connectionIndicator = ConnectionIndicator.instance;
//#endregion
export { ConnectionStateStore as a, ConnectionState as i, LoadingBarState as n, isLocalhost as o, connectionIndicator as r, ConnectionIndicator as t };

//# sourceMappingURL=ConnectionIndicator-BWQlTKGG.js.map