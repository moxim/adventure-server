...
var f$1, h$1 = void 0, s$1 = 0, v$1 = 0, e = 0, c$1 = void 0, d$1 = 0;
function a$1(i) {
	if (void 0 !== r) {
		var t = i.n;
		if (void 0 === t || t.t !== r) {
...
//#endregion
//#region node_modules/@preact/signals-react/runtime/dist/runtime.module.js
var import_react = /* @__PURE__ */ __toESM(require_react());
var import_shim = require_shim();
var l = import_react.version.split(".").map(Number)[0], v = [], d = Symbol.for(l >= 19 ? "react.transitional.element" : "react.element"), m = "undefined" != typeof window && !!window.__PREACT_SIGNALS_DEVTOOLS__;
function p(t) {
	if ("function" != typeof t) return t;
	else return function(r, e) {
		if ("string" == typeof r && e) for (var i in e) {
			var u = e[i];
			if ("children" !== i && u instanceof l$1) e[i] = u.value;
		}
...
var k = "undefined" != typeof window ? import_react.useLayoutEffect : import_react.useEffect;
function C(n, t) {
	if (void 0 === n) n = 0;
	P();
	...
	if (null == r.current) if ("undefined" == typeof window) r.current = x;
		...
		var r, i, u, o, f = 0, c = j$1(function() {
			i = this;
		}, { name: t || "Component" });
		i.c = function() {
			f = f + 1 | 0;
...
//#endregion
export { C as _useSignalsImplementation, P as ensureFinalCleanup, useComputed, O as useModel, useSignal, useSignalEffect, N as useSignals, p as wrapJsx };
