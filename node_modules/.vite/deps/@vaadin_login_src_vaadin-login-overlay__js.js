...
import { t as SlotChildObserveController } from "./slot-child-observe-controller-DRwVKtF7.js";
...
import "./vaadin-password-field-DD29-GAr.js";
import { t as LoginFormMixin } from "./vaadin-login-form-mixin-C6RvEwEs.js";
/**
* @license
* Copyright (c) 2018 - 2026 Vaadin Ltd.
* This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
*/
var loginOverlayWrapperStyles = [overlayStyles, css`
  [part='overlay'] {
...
`];
//#endregion
//#region node_modules/@vaadin/login/src/vaadin-login-overlay-wrapper.js
/**
* @license
* Copyright (c) 2018 - 2026 Vaadin Ltd.
* This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
...
* @private
*/
var LoginOverlayWrapper = class extends OverlayMixin(DirMixin(ThemableMixin(PolylitMixin(LumoInjectionMixin(LitElement))))) {
	static get is() {
...
//#endregion
//#region node_modules/@vaadin/login/src/title-controller.js
/**
* @license
* Copyright (c) 2018 - 2026 Vaadin Ltd.
* This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
...
*/
var TitleController = class extends SlotChildObserveController {
	constructor(host) {
	...
	*/
	setTitle(title) {
		this.title = title;
		if (!this.getSlotChild()) this.restoreDefaultNode();
		if (this.node === this.defaultNode) this.updateDefaultNode(this.node);
	}
	/**
	...
	*/
	initNode(node) {
		if (node === this.defaultNode) node.setAttribute("role", "heading");
...
//#endregion
//#region node_modules/@vaadin/login/src/vaadin-login-overlay-mixin.js
/**
* @license
* Copyright (c) 2018 - 2026 Vaadin Ltd.
* This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
*/
var LoginOverlayMixin = (superClass) => class LoginOverlayMixin extends superClass {
	static get properties() {
		return {
			/**
			...
			*/
			...
			/** @private */
			__effectiveTitle: { type: String },
			/** @private */
			__effectiveDescription: { type: String }
		};
	}
	/** @protected */
	firstUpdated() {
	...
	updated(props) {
		super.updated(props);
		if (props.has("__effectiveTitle")) this.__titleController.setTitle(this.__effectiveTitle);
		if (props.has("headingLevel")) this.__titleController.setLevel(this.headingLevel);
		if (props.has("opened")) this._openedChanged(this.opened, props.get("opened"));
	}
	/** @protected */
	connectedCallback() {
	...
	_openedChanged(opened, oldOpened) {
		if (oldOpened) {
			...
			this.disabled = false;
		} else if (opened) document.body.style.pointerEvents = this.$.overlay._previousDocumentPointerEvents;
	}
};
//#endregion
//#region node_modules/@vaadin/login/src/vaadin-login-overlay.js
/**
* @license
* Copyright (c) 2018 - 2026 Vaadin Ltd.
* This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
...
* @extends HTMLElement
*/
var LoginOverlay = class extends LoginFormMixin(LoginOverlayMixin(ElementMixin(ThemableMixin(PolylitMixin(LitElement))))) {
	static get is() {
...
//# sourceMappingURL=@vaadin_login_src_vaadin-login-overlay__js.js.map