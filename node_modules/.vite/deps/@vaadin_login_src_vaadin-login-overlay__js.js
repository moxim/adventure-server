...
import "./vaadin-password-field-Miz3JCdM.js";
import { t as LoginFormMixin } from "./vaadin-login-form-mixin-Da8kuGgm.js";
/**
* @license
...
var LoginOverlayMixin = (superClass) => class LoginOverlayMixin extends superClass {
	...
	updated(props) {
		...
		if (props.has("opened")) this._openedChanged(this.opened);
	}
	/** @protected */
	connectedCallback() {
