...
class RemoveActionEditorTest {

    private AdventureData adventureData;
    private RemoveActionData removeActionData;
    ...
    void setUp() {
        ...
        removeActionData = new RemoveActionData();
    }

    @Test
    void validate_withNoItemSelected_shouldReturnFalse() {
        // Given
        RemoveActionEditor editor = new RemoveActionEditor(removeActionData, adventureData);
        editor.initialize();
    ...
    void validate_withItemPreSelected_shouldReturnTrue() {
        ...
        removeActionData.setThingId(item1.getId());
        RemoveActionEditor editor = new RemoveActionEditor(removeActionData, adventureData);
        editor.initialize();
    ...
    void validate_withItemFromPlayerPocketPreSelected_shouldReturnTrue() {
        ...
        removeActionData.setThingId(item3.getId());
        RemoveActionEditor editor = new RemoveActionEditor(removeActionData, adventureData);
        editor.initialize();
    ...
    void constructor_shouldSetActionData() {
        ...
        // Then
        assertThat(editor.getActionData()).isSameAs(removeActionData);
    }
    ...
    @Test
    void getActionTypeName_shouldReturnRemoveActionName() {
        // Given
        RemoveActionEditor editor = new RemoveActionEditor(removeActionData, adventureData);
        ...
        // Then
        assertThat(actionTypeName).isEqualTo(removeActionData.getActionName());
    }
}
