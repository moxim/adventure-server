...
public class DecrementVariableActionMapper extends ActionMapper<DecrementVariableActionData, DecrementVariableAction> {
    ...
    public DecrementVariableActionMapper(MessagesHolder aMessagesHolder, MapperSupporter aMapperSupporter) {
    ...
    public DecrementVariableAction mapToBO(DecrementVariableActionData from) {
        return new DecrementVariableAction(from.getName(), from.getValue(), getMapperSupporter().getVariableProvider(), messagesHolder);
    }
