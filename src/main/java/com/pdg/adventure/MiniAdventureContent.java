...
public class MiniAdventureContent {
    ...
    public MiniAdventureContent(AdventureConfig adventureConfig, GameContext gameContext, CommandFactory commandFactory) {
        ...
        this.allWords = adventureConfig.allWords();
        this.allLocations = adventureConfig.allLocations();
        this.variableProvider = adventureConfig.allVariables();
        this.allItems = new GenericContainer(new DescriptionProvider("all items"), 9999);
    }
    ...
    private void setUpLocations() {
        ...
        commandFactory.setUpLookCommands(location);
        ...
        commandFactory.setUpLookCommands(portal);
        ...
        commandFactory.setUpLookCommands(house);
    ...
    private void setUpItems() {
        ...
        commandFactory.setUpWearCommands(gloves);
        commandFactory.setUpLookCommands(gloves);
        commandFactory.setUpTakeCommands(gloves);
        ...
        commandFactory.setUpLookCommands(knife);
        commandFactory.setUpTakeCommands(knife);

        // rabbit
        Item pelt = new Item(new DescriptionProvider(SMALL_TEXT, "pelt"), true);
        allItems.add(pelt);
        pelt.setLongDescription(allMessages.getMessage("19"));
        commandFactory.setUpLookCommands(pelt);
        commandFactory.setUpTakeCommands(pelt);
        ...
        commandFactory.setUpLookCommands(skinnedRabbit);
        commandFactory.setUpTakeCommands(skinnedRabbit);
        ...
        allItems.add(ring);
        commandFactory.setUpWearCommands(ring);
        commandFactory.setUpLookCommands(ring);
        commandFactory.setUpTakeCommands(ring);
    }
    ...
    private void setUpDirections() {
        ...
        commandFactory.setUpLookCommands(toPortal);
        ...
        commandFactory.setUpLookCommands(toHouse);
