...
}, Ka = process.env.NODE_ENV !== "production" ? Ja : {};
function h(t) {
...
var Qa = {};
function Br() {
  return typeof globalThis < "u" ? globalThis : typeof window < "u" ? window : typeof global < "u" ? global : typeof self < "u" ? self : Qa;
}
var xi = Object.assign, Ft = Object.getOwnPropertyDescriptor, _ = Object.defineProperty, sr = Object.prototype, Xt = [];
Object.freeze(Xt);
var Yr = {};
Object.freeze(Yr);
var Ba = typeof Proxy < "u", Ya = /* @__PURE__ */ Object.toString();
function Si() {
  Ba || h(process.env.NODE_ENV !== "production" ? "`Proxy` objects are not available in the current environment. Please configure MobX to enable a fallback implementation.`" : "Proxy not available");
}
function st(t) {
...
function C(t) {
  ...
  return typeof r == "function" && r.toString() === Ya;
}
function ki(t) {
  var e = t?.constructor;
...
var Oi = typeof Object.getOwnPropertySymbols < "u";
function _a(t) {
  var e = Object.keys(t);
  if (!Oi)
    return e;
...
var gt = typeof Reflect < "u" && Reflect.ownKeys ? Reflect.ownKeys : Oi ? function(t) {
...
function Vi(t, e, r) {
  ...
  var o = new fe(t);
  return e !== Je && fs(o, e), r !== Je && $i(o, r), o;
}
function nn(t, e) {
  return da(t, e);
}
...
function Ve(t, e, r) {
  return yt(t) ? t : Array.isArray(t) ? k.array(t, {
    ...
    name: r
  }) : typeof t == "function" && !Te(t) && !bt(t) ? ki(t) ? Ge(t) : mt(r, t) : t;
}
function ln(t, e, r) {
...
function cn(t, e) {
  return process.env.NODE_ENV !== "production" && yt(t) && h("observable.struct should not be used with observable values"), da(t, e) ? e : t;
}
var dn = "override";
function Ht(t) {
...
function Ci(t, e, r, o, i) {
  var a, n, s, l, c, d, p;
  i === void 0 && (i = u.safeDescriptors), vn(t, e, r, o);
  var v = o.value;
...
function fn(t, e, r, o) {
  ...
  if (bt(r.value))
    return 1;
  var a = Ti(t, this, e, r, !1, !1);
  return _(o, e, a), 2;
}
function gn(t, e, r, o) {
  var i, a = Ti(t, this, e, r, (i = this.options_) == null ? void 0 : i.bound);
...
function Ti(t, e, r, o, i, a) {
  a === void 0 && (a = u.safeDescriptors), bn(t, e, r, o);
  var n = o.value;
  if (bt(n) || (n = Ge(n)), i) {
    var s;
...
function wn(t, e, r, o) {
  return Sn(t, this, e, r), t.defineComputedProperty_(e, he({}, this.options_, {
    get: r.get,
    set: r.set
  }), o);
}
...
function En(t, e, r, o) {
  var i, a;
  return An(t, this, e, r), t.defineObservableProperty_(e, r.value, (i = (a = this.options_) == null ? void 0 : a.enhancer) != null ? i : Ve, o);
}
function On(t, e) {
  if (process.env.NODE_ENV !== "production") {
    if (e.kind === "field")
...
var Dn = "observable", In = "observable.ref", zn = "observable.shallow", Rn = "observable.struct", Ii = {
  deep: !0,
  name: void 0,
...
var Lr = /* @__PURE__ */ pr(Dn), qn = /* @__PURE__ */ pr(In, {
  enhancer: ur
}), Ln = /* @__PURE__ */ pr(zn, {
  enhancer: ln
}), Mn = /* @__PURE__ */ pr(Rn, {
...
function Un(t) {
  var e;
  return t ? (e = t.defaultDecorator) != null ? e : Di(t) : void 0;
}
function Zn(t) {
  var e, r;
...
var jn = {
  ...
  object: function(e, r, o) {
    return Ue(function() {
      return ta(u.useProxies === !1 || o?.proxy === !1 ? tt({}, o) : As({}, o), e, r);
    });
  },
  ref: /* @__PURE__ */ $(qn),
  shallow: /* @__PURE__ */ $(Ln),
  deep: zi,
  struct: /* @__PURE__ */ $(Mn)
}, k = /* @__PURE__ */ xi(Ri, jn), qi = "computed", Wn = "computed.struct", Mr = /* @__PURE__ */ $r(qi), Fn = /* @__PURE__ */ $r(Wn, {
...
function Ce(t, e, r, o) {
  ...
  function i() {
    return Li(t, r, e, o || this, arguments);
  }
  return i.isMobxAction = !0, i.toString = function() {
    return e.toString();
  }, Hn && (So.value = t, _(i, "name", So)), i;
}
function Li(t, e, r, o, i) {
  var a = Jn(t, e, o, i);
  try {
    return r.apply(o, i);
  } catch (n) {
...
var Bn = "create", Ae = /* @__PURE__ */ function(t) {
  ...
  return e.onBecomeStale_ = function() {
    ...
    var i = vr(!1), a;
    if (o)
      a = Mi(this, this.derivation, this.scope_);
...
function Ur(t) {
  switch (t.dependenciesState_) {
    ...
    case b.POSSIBLY_STALE_: {
      for (var e = eo(!0), r = Me(), o = t.observing_, i = o.length, a = 0; a < i; a++) {
        var n = o[a];
        if (gr(n)) {
...
function Mi(t, e, r) {
  var o = eo(!0);
  Zi(t), t.newObserving_ = new Array(
  ...
  return u.inBatch--, u.trackingDerivation = i, _n(t), Gn(t), ht(o), a;
}
function Gn(t) {
...
function _n(t) {
  ...
  for (r.length = i, t.newObserving_ = null, a = e.length; a--; ) {
    var l = e[a];
    l.diffValue === 0 && ji(l, t), l.diffValue = 0;
  }
  for (; i--; ) {
    var c = r[i];
...
function ji(t, e) {
  t.observers_.delete(e), t.observers_.size === 0 && Wi(t);
}
function Wi(t) {
...
function Fi(t) {
  ...
  return e !== null ? (e.runId_ !== t.lastAccessedBy_ && (t.lastAccessedBy_ = e.runId_, e.newObserving_[e.unboundDepsCount_++] = t, !t.isBeingObserved && u.trackingContext && (t.isBeingObserved = !0, t.onBO())), t.isBeingObserved) : (t.observers_.size === 0 && u.inBatch > 0 && Wi(t), !1);
}
function Xi(t) {
  t.lowestObserverState_ !== b.STALE_ && (t.lowestObserverState_ = b.STALE_, t.observers_.forEach(function(e) {
    e.dependenciesState_ === b.UP_TO_DATE_ && (process.env.NODE_ENV !== "production" && e.isTracing_ !== W.NONE && Hi(e, t), e.onBecomeStale_()), e.dependenciesState_ = b.STALE_;
  }));
}
function es(t) {
  t.lowestObserverState_ !== b.STALE_ && (t.lowestObserverState_ = b.STALE_, t.observers_.forEach(function(e) {
    e.dependenciesState_ === b.POSSIBLY_STALE_ ? (e.dependenciesState_ = b.STALE_, process.env.NODE_ENV !== "production" && e.isTracing_ !== W.NONE && Hi(e, t)) : e.dependenciesState_ === b.UP_TO_DATE_ && (t.lowestObserverState_ = b.UP_TO_DATE_);
  }));
}
function ts(t) {
...
function Hi(t, e) {
  if (console.log("[mobx.trace] '" + t.name_ + "' is invalidated due to a change in: '" + e.name_ + "'"), t.isTracing_ === W.BREAK) {
    var r = [];
    Ji(gs(t), r, 1), new Function(`debugger;
/*
Tracing '` + t.name_ + `'
...
var ee = /* @__PURE__ */ function() {
  ...
  return e.onBecomeStale_ = function() {
    ...
    this.isScheduled || (this.isScheduled = !0, u.pendingReactions.push(this), Ki());
    ...
    if (!this.isDisposed) {
      ...
      var s = Mi(this, o, void 0);
      u.trackingContext = n, this.isRunning = !1, this.isTrackPending = !1, this.isDisposed && Zr(this), Zt(s) && this.reportExceptionInDerivation_(s.cause), process.env.NODE_ENV !== "production" && i && q({
        time: Date.now() - a
      }), j();
    }
...
function Ki() {
  u.inBatch > 0 || u.isRunningReactions || os(is);
}
function is() {
...
var to = "action", ss = "action.bound", Qi = "autoAction", ls = "autoAction.bound", Bi = "<unnamed action>", jr = /* @__PURE__ */ At(to), cs = /* @__PURE__ */ At(ss, {
  bound: !0
}), Wr = /* @__PURE__ */ At(Qi, {
  autoAction: !0
}), ds = /* @__PURE__ */ At(ls, {
...
function Yi(t) {
  var e = function(o, i) {
    if (E(o))
      return Ce(o.name || Bi, o, t);
    if (E(i))
      return Ce(o, i, t);
    if (Ot(i))
      return (t ? Wr : jr).decorate_20223_(o, i);
    if (Pe(i))
      return Et(o, i, t ? Wr : jr);
    if (Pe(o))
      return $(At(t ? Qi : to, {
        name: o,
        autoAction: t
...
var Se = /* @__PURE__ */ Yi(!1);
Object.assign(Se, jr);
var mt = /* @__PURE__ */ Yi(!0);
Object.assign(mt, Wr);
Se.bound = /* @__PURE__ */ $(cs);
mt.bound = /* @__PURE__ */ $(ds);
function Ad(t) {
  return Li(t.name || Bi, !1, t, this, void 0);
}
function Te(t) {
...
function ro(t, e, r) {
  ...
  var n = (o = r.name) != null ? o : process.env.NODE_ENV !== "production" ? "Reaction@" + X() : "Reaction", s = Se(n, r.onError ? ps(r.onError, e) : e), l = !r.scheduler && !r.delay, c = _i(r), d = !0, p = !1, v, m = r.compareStructural ? Ye.structural : r.equals || Ye.default, w = new ee(n, function() {
    d || l ? N() : p || (p = !0, c(N));
...
function ra(t) {
  ...
  return t.observing_ && t.observing_.length > 0 && (e.dependencies = ms(t.observing_).map(ra)), e;
}
function ms(t) {
...
oa.prototype = /* @__PURE__ */ Object.create(Error.prototype);
var Or = /* @__PURE__ */ Ni("flow"), ys = /* @__PURE__ */ Ni("flow.bound", {
  bound: !0
  ...
  var o = e, i = o.name || "<unnamed flow>", a = function() {
    var s = this, l = arguments, c = ++bs, d = Se(i + " - runid: " + c + " - init", o).apply(s, l), p, v = void 0, m = new Promise(function(w, N) {
      var T = 0;
      p = N;
      function be(D) {
        v = void 0;
...
function As(t, e) {
  var r, o;
  return Si(), t = tt(t, e), (o = (r = t[g]).proxy_) != null ? o : r.proxy_ = new Proxy(t, Os);
}
function M(t) {
...
function Ct(t, e, r) {
  return process.env.NODE_ENV !== "production" && (!C(t) && !C(Object.getPrototypeOf(t)) && h("'makeAutoObservable' can only be used for classes that don't have a superclass"), rt(t) && h("makeAutoObservable can only be used on objects not already made observable")), C(t) ? ta(t, t, e, r) : (Ue(function() {
    var o = tt(t, r)[g];
    if (!t[Ar]) {
...
var Oo = "splice", H = "update", Ps = 1e4, Vs = {
  ...
  return e.dehanceValue_ = function(o) {
    ...
    o !== this.lastKnownLength_ && h(16), this.lastKnownLength_ += i, this.legacyMode_ && i > 0 && ca(o + i + 1);
...
function Cs(t, e, r, o) {
  return r === void 0 && (r = process.env.NODE_ENV !== "production" ? "ObservableArray@" + X() : "ObservableArray"), o === void 0 && (o = !1), Si(), Ue(function() {
    var i = new oo(r, e, o, !1);
    Ei(i.values_, g, i);
    var a = new Proxy(i.values_, Vs);
...
var Ts = {}, pe = "add", Yt = "delete", aa = /* @__PURE__ */ function() {
  function t(r, o, i) {
    var a = this;
    o === void 0 && (o = Ve), i === void 0 && (i = process.env.NODE_ENV !== "production" ? "ObservableMap@" + X() : "ObservableMap"), this.enhancer_ = void 0, this.name_ = void 0, this[g] = Ts, this.data_ = void 0, this.hasMap_ = void 0, this.keysAtom_ = void 0, this.interceptors_ = void 0, this.changeListeners_ = void 0, this.dehancer = void 0, this.enhancer_ = o, this.name_ = i, E(Map) || h(18), Ue(function() {
      a.keysAtom_ = Vi(process.env.NODE_ENV !== "production" ? a.name_ + ".keys()" : "ObservableMap.keys()"), a.data_ = /* @__PURE__ */ new Map(), a.hasMap_ = /* @__PURE__ */ new Map(), r && a.merge(r);
    });
  }
  var e = t.prototype;
  return e.has_ = function(o) {
    ...
    if (!a) {
      var n = a = new Ae(this.has_(o), ur, process.env.NODE_ENV !== "production" ? this.name_ + "." + Rr(o) + "?" : "ObservableMap.key?", !1);
      this.hasMap_.set(o, n), $i(n, function() {
    ...
    G(this.keysAtom_), ne(function() {
      var c, d = new Ae(i, a.enhancer_, process.env.NODE_ENV !== "production" ? a.name_ + "." + Rr(o) : "ObservableMap.key", !1);
    ...
    return ge(o) && (o = new Map(o)), ne(function() {
      C(o) ? _a(o).forEach(function(a) {
        return i.set(a, o[a]);
      }) : Array.isArray(o) ? o.forEach(function(a) {
        var n = a[0], s = a[1];
        return i.set(n, s);
      }) : $e(o) ? (Ga(o) || h(19, o), o.forEach(function(a, n) {
        return i.set(n, a);
      })) : o != null && h(20, o);
    }), this;
  }, e.clear = function() {
    ...
    var i = this;
    return ne(function() {
      for (var a = Ds(o), n = /* @__PURE__ */ new Map(), s = !1, l = Ke(i.data_.keys()), c; !(c = l()).done; ) {
        var d = c.value;
        if (!a.has(d)) {
          var p = i.delete(d);
          if (p)
      ...
      if (!s)
        if (i.data_.size !== n.size)
          ...
          for (var D = i.data_.keys(), de = n.keys(), ye = D.next(), bo = de.next(); !ye.done; ) {
            if (ye.value !== bo.value) {
              i.keysAtom_.reportChanged();
              break;
            }
            ye = D.next(), bo = de.next();
          }
      i.data_ = n;
    }), this;
  }, e.toString = function() {
...
}(), ge = /* @__PURE__ */ Le("ObservableMap", aa);
function Ao(t) {
  return t[Symbol.toStringTag] = "MapIterator", ao(t);
}
function Ds(t) {
  if ($e(t) || ge(t))
    return t;
...
var Is = {}, na = /* @__PURE__ */ function() {
  function t(r, o, i) {
    var a = this;
    o === void 0 && (o = Ve), i === void 0 && (i = process.env.NODE_ENV !== "production" ? "ObservableSet@" + X() : "ObservableSet"), this.name_ = void 0, this[g] = Is, this.data_ = /* @__PURE__ */ new Set(), this.atom_ = void 0, this.changeListeners_ = void 0, this.interceptors_ = void 0, this.dehancer = void 0, this.enhancer_ = void 0, this.name_ = i, E(Set) || h(22), this.enhancer_ = function(n, s) {
      return o(n, s, i);
    }, Ue(function() {
      a.atom_ = Vi(a.name_), r && a.replace(r);
    });
  }
  var e = t.prototype;
  return e.dehanceValue_ = function(o) {
...
}(), Y = /* @__PURE__ */ Le("ObservableSet", na);
function Po(t) {
  return t[Symbol.toStringTag] = "SetIterator", ao(t);
}
var Vo = /* @__PURE__ */ Object.create(null), Co = "remove", Fr = /* @__PURE__ */ function() {
  function t(r, o, i, a) {
    o === void 0 && (o = /* @__PURE__ */ new Map()), a === void 0 && (a = Vn), this.target_ = void 0, this.values_ = void 0, this.name_ = void 0, this.defaultAnnotation_ = void 0, this.keysAtom_ = void 0, this.changeListeners_ = void 0, this.interceptors_ = void 0, this.proxy_ = void 0, this.isPlainObject_ = void 0, this.appliedAnnotations_ = void 0, this.pendingKeys_ = void 0, this.target_ = r, this.values_ = o, this.name_ = i, this.defaultAnnotation_ = a, this.keysAtom_ = new fe(process.env.NODE_ENV !== "production" ? this.name_ + ".keys" : "ObservableObject.keys"), this.isPlainObject_ = C(this.target_), process.env.NODE_ENV !== "production" && !ua(this.defaultAnnotation_) && h("defaultAnnotation must be valid annotation"), process.env.NODE_ENV !== "production" && (this.appliedAnnotations_ = {});
  }
  var e = t.prototype;
  return e.getObservablePropValue_ = function(o) {
    ...
    return i || (i = new Ae(o in this.target_, ur, process.env.NODE_ENV !== "production" ? this.name_ + "." + Rr(o) + "?" : "ObservableObject.key?", !1), this.pendingKeys_.set(o, i)), i.get();
  }, e.make_ = function(o, i) {
    if (i === !0 && (i = this.defaultAnnotation_), i !== !1) {
      if (Do(this, i, o), !(o in this.target_)) {
        var a;
    ...
    try {
      ...
      if (process.env.NODE_ENV !== "production" && delete this.appliedAnnotations_[o], c && (this.values_.delete(o), c instanceof Ae && (d = c.value_), Xi(c)), this.keysAtom_.reportChanged(), (n = this.pendingKeys_) == null || (n = n.get(o)) == null || n.set(o in this.target_), s || l) {
        var v = {
          type: Co,
          observableKind: "object",
          object: this.proxy_ || this.target_,
...
Extending builtins is not supported.`), t;
  ...
  var o = (r = e?.name) != null ? r : process.env.NODE_ENV !== "production" ? (C(t) ? "ObservableObject" : t.constructor.name) + "@" + X() : "ObservableObject", i = new Fr(t, /* @__PURE__ */ new Map(), String(o), Un(e));
  return cr(t, g, i), t;
}
var zs = /* @__PURE__ */ Le("ObservableObjectAdministration", Fr);
function No(t) {
  return Vo[t] || (Vo[t] = {
    get: function() {
...
function Do(t, e, r) {
  if (process.env.NODE_ENV !== "production" && !ua(e) && h("Cannot annotate '" + t.name_ + "." + r.toString() + "': Invalid annotation."), process.env.NODE_ENV !== "production" && !Ht(e) && J(t.appliedAnnotations_, r)) {
...
var Rs = /* @__PURE__ */ la(0), qs = /* @__PURE__ */ function() {
  var t = !1, e = {};
...
var io = /* @__PURE__ */ function(t) {
  function e(o, i, a, n) {
    ...
    return a === void 0 && (a = process.env.NODE_ENV !== "production" ? "ObservableArray@" + X() : "ObservableArray"), n === void 0 && (n = !1), s = t.call(this) || this, Ue(function() {
      var l = new oo(a, i, n, !0);
      l.proxy_ = s, Ei(s, g, l), o && o.length && s.spliceWithArray(0, 0, o), qs && Object.defineProperty(s, "0", Rs);
    }), s;
  }
  Pi(e, t);
  var r = e.prototype;
...
function il() {
  return `__reactFiber$${ha()}`;
}
function al() {
  return `__reactContainer$${ha()}`;
}
function ha() {
...
function ut(t) {
  const e = t.type;
  return e?.$$typeof === pa && !e.displayName && t.child ? ut(t.child) : _t(t.type) ?? _t(t.elementType) ?? "???";
}
function nl() {
  const t = Array.from(document.querySelectorAll("body > *")).flatMap((r) => r[al()]).find((r) => r), e = Ie(t);
  return Ie(e?.child);
}
function sl(t) {
  const e = [];
...
function dl(t) {
  return typeof t.type != "function" || va(t) ? !1 : !!($t(t) || rl(t));
}
function va(t) {
  if (!t)
    return !1;
...
const br = async (t, e, r) => window.Vaadin.copilot.comm(t, e, r), ot = "copilot-", ul = "25.1.1", pl = "undefined", Cd = "attention-required", Nd = "https://plugins.jetbrains.com/plugin/23758-vaadin", Td = "https://marketplace.visualstudio.com/items?itemName=vaadin.vaadin-vscode", Dd = "https://marketplace.eclipse.org/content/vaadin-tools";
function Id(t) {
...
const ga = (t, e, r) => e >= t.left && e <= t.right && r >= t.top && r <= t.bottom, ma = (t) => {
  const e = [];
  let r = Uo(t);
  for (; r; )
    e.push(r), r = Uo(r);
...
function Md(t) {
  const e = ya(t), r = ba(e);
  !e.every((i) => Ol(i, r)) && e.length > 0 && e[0].scrollIntoView();
}
function ya(t) {
  const e = t;
  if (!e)
  ...
  return e.children.flatMap((o) => ya(o));
}
function Ud(t, e) {
  function r(o) {
...
function Vl(t) {
  ...
  !ga(document.documentElement.getBoundingClientRect(), e, r);
}
function Fo(t) {
...
var wa = /* @__PURE__ */ ((t) => (t["vaadin-combo-box"] = "vaadin-combo-box", t["vaadin-date-picker"] = "vaadin-date-picker", t["vaadin-dialog"] = "vaadin-dialog", t["vaadin-multi-select-combo-box"] = "vaadin-multi-select-combo-box", t["vaadin-select"] = "vaadin-select", t["vaadin-time-picker"] = "vaadin-time-picker", t["vaadin-popover"] = "vaadin-popover", t))(wa || {});
const Fe = {
  "vaadin-combo-box": {
    hideOnActivation: !0,
    open: (t) => Rt(t),
  ...
  "vaadin-select": {
    ...
    open: (t) => {
      const e = t;
      Sa(e, e._overlayElement), e.opened = !0;
    },
    close: (t) => {
      const e = t;
      ka(e, e._overlayElement), e.opened = !1;
    }
  },
  ...
  t.addEventListener("focusout", xa, { capture: !0 }), Sa(t), t.opened = !0;
}, qt = (t) => {
  ka(t), t.removeAttribute("focused"), t.removeEventListener("focusout", xa, { capture: !0 }), t.opened = !1;
}, Sa = (t, e) => {
  const r = e ?? t.$.overlay;
...
class Nl {
  ...
  overlayStatus(e) {
    if (!e)
      return { visible: !1 };
    const r = e.localName;
    let o = Object.keys(wa).includes(r);
    if (!o)
      return { visible: !1 };
...
class Dl {
  ...
  addRecentSwitchedUsername(e) {
    this.setRecentSwitchedUsernames(bl([e, ...this.recentSwitchedUsernames]));
  }
...
class Rl {
  constructor() {
    this.palette = { components: [] }, Ct(this), this.initializer = new Ea(), this.initializer.promise.then(() => {
      ro(
        () => JSON.stringify(this),
        () => {
          te("copilot-set-project-state-configuration", { conf: JSON.stringify(Ko(this)) });
        }
      );
...
window.Vaadin.copilot._earlyProjectState = new zl();
/**
 * @license
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: Ml, defineProperty: Ul, getOwnPropertyDescriptor: Zl, getOwnPropertyNames: jl, getOwnPropertySymbols: Wl, getPrototypeOf: Fl } = Object, wr = globalThis, Yo = wr.trustedTypes, Xl = Yo ? Yo.emptyScript : "", Hl = wr.reactiveElementPolyfillSupport, vt = (t, e) => t, ir = { toAttribute(t, e) {
  switch (e) {
    case Boolean:
      t = t ? Xl : null;
      break;
  ...
  return r;
} }, lo = (t, e) => !Ml(t, e), Go = { attribute: !0, type: String, converter: ir, reflect: !1, useDefault: !1, hasChanged: lo };
...
let He = class extends HTMLElement {
  ...
  static getPropertyDescriptor(e, r, o) {
    const { get: i, set: a } = Zl(this.prototype, e) ?? { get() {
      return this[r];
    }, set(n) {
      this[r] = n;
    } };
  ...
  static finalizeStyles(e) {
    ...
    if (Array.isArray(e)) {
      ...
      for (const i of o) r.unshift(Bo(i));
  ...
  requestUpdate(e, r, o) {
    if (e !== void 0) {
      ...
      if (o ??= i.getPropertyOptions(e), !((o.hasChanged ?? lo)(a, r) || o.useDefault && o.reflect && a === this._$Ej?.get(e) && !this.hasAttribute(i._$Eu(e, o)))) return;
      this.C(e, r, o);
    }
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Jl = { attribute: !0, type: String, converter: ir, reflect: !1, hasChanged: lo }, Kl = (t = Jl, e, r) => {
...
function it(t) {
  return (e, r) => typeof r == "object" ? Kl(t, e, r) : ((o, i, a) => {
...
function Bl(t, e) {
  ...
  return o = class extends t {
    ...
    connectedCallback() {
      ...
      this[Xe] = new e(`${a}.update()`, this[_o]), this.hasUpdated && this.requestUpdate();
    }
    disconnectedCallback() {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const uo = globalThis, ar = uo.trustedTypes, $o = ar ? ar.createPolicy("lit-html", { createHTML: (t) => t }) : void 0, Pa = "$lit$", ue = `lit$${Math.random().toFixed(9).slice(2)}$`, Va = "?" + ue, Gl = `<${Va}>`, ze = document, wt = () => ze.createComment(""), xt = (t) => t === null || typeof t != "object" && typeof t != "function", po = Array.isArray, _l = (t) => po(t) || typeof t?.[Symbol.iterator] == "function", Cr = `[ 	
\f\r]`, lt = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, ei = /-->/g, ti = />/g, xe = RegExp(`>|${Cr}(?:([^\\s"'>=/]+)(${Cr}*=${Cr}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), ri = /'/g, oi = /"/g, Ca = /^(?:script|style|textarea|title)$/i, Na = (t) => (e, ...r) => ({ _$litType$: t, strings: e, values: r }), le = Na(1), Fd = Na(2), Re = Symbol.for("lit-noChange"), S = Symbol.for("lit-nothing"), ii = /* @__PURE__ */ new WeakMap(), Ee = ze.createTreeWalker(ze, 129);
function Ta(t, e) {
...
const $l = (t, e) => {
  ...
  for (let s = 0; s < r; s++) {
    const l = t[s];
    let c, d, p = -1, v = 0;
    for (; v < l.length && (n.lastIndex = v, d = n.exec(l), d !== null); ) v = n.lastIndex, n === lt ? d[1] === "!--" ? n = ei : d[1] !== void 0 ? n = ti : d[2] !== void 0 ? (Ca.test(d[2]) && (i = RegExp("</" + d[2], "g")), n = xe) : d[3] !== void 0 && (n = xe) : n === xe ? d[0] === ">" ? (n = i ?? lt, p = -1) : d[1] === void 0 ? p = -2 : (p = n.lastIndex - d[2].length, c = d[1], n = d[3] === void 0 ? xe : d[3] === '"' ? oi : ri) : n === oi || n === ri ? n = xe : n === ei || n === ti ? n = lt : (n = xe, i = void 0);
    const m = n === xe && t[s + 1].startsWith("/>") ? " " : "";
    a += n === lt ? l + Gl : p >= 0 ? (o.push(c), l.slice(0, p) + Pa + l.slice(p) + ue + m) : l + ue + (p === -2 ? s : m);
  }
  return [Ta(t, a + (t[r] || "<?>") + (e === 2 ? "</svg>" : e === 3 ? "</math>" : "")), o];
};
class St {
  constructor({ strings: e, _$litType$: r }, o) {
    ...
    for (; (i = Ee.nextNode()) !== null && l.length < s; ) {
      if (i.nodeType === 1) {
        if (i.hasAttributes()) for (const p of i.getAttributeNames()) if (p.endsWith(Pa)) {
          const v = d[n++], m = i.getAttribute(p).split(ue), w = /([.?@])?(.*)/.exec(v);
          l.push({ type: 1, index: a, name: w[2], strings: m, ctor: w[1] === "." ? tc : w[1] === "?" ? rc : w[1] === "@" ? oc : xr }), i.removeAttribute(p);
        } else p.startsWith(ue) && (l.push({ type: 6, index: a }), i.removeAttribute(p));
        if (Ca.test(i.tagName)) {
      ...
      } else if (i.nodeType === 8) if (i.data === Va) l.push({ type: 2, index: a });
      else {
        let p = -1;
...
class ec {
  ...
  u(e) {
    ...
    for (; l !== void 0; ) {
      if (n === l.index) {
        let c;
        l.type === 2 ? c = new at(a, a.nextSibling, this, e) : l.type === 1 ? c = new l.ctor(a, l.name, l.strings, this, e) : l.type === 6 && (c = new ic(a, this, e)), this._$AV.push(c), l = o[++s];
      }
...
class at {
  ...
  $(e) {
    const { values: r, _$litType$: o } = e, i = typeof o == "number" ? this._$AC(e) : (o.el === void 0 && (o.el = St.createElement(Ta(o.h, o.h[0]), this.options)), o);
    if (this._$AH?._$AD === i) this._$AH.p(r);
    else {
      const a = new ec(i, this), n = a.u(this.options);
      a.p(r), this.T(n), this._$AH = a;
    }
  }
  _$AC(e) {
    let r = ii.get(e.strings);
    return r === void 0 && ii.set(e.strings, r = new St(e)), r;
  }
  k(e) {
...
const Xd = { I: at }, ac = uo.litHtmlPolyfillSupport;
ac?.(St, at), (uo.litHtmlVersions ??= []).push("3.3.0");
const nc = (t, e, r) => {
...
let Da = !1;
function dc() {
  kt().publicPluginsState === "NOT_INITIALIZED" && (oe.push(import("./copilot-log-plugin-VBNvctqy.js")), oe.push(import("./copilot-info-plugin-Bnxgq4Ys.js")), oe.push(import("./copilot-features-plugin-NgBkoSWi.js")), oe.push(import("./copilot-feedback-plugin-yOLhyTb5.js")), oe.push(import("./copilot-settings-panel-IvQem6wu.js")), oe.push(import("./copilot-impersonator-plugin-DDoFO-NU.js")), oe.push(import("./copilot-development-setup-user-guide-B-Q4G6Bc.js")), Da = !0, kt().setPublicPluginsState("IMPORTED"));
}
function Nr() {
...
function uc() {
  Promise.all(oe).then(() => {
    ...
    if (t.copilot.plugins) {
      ...
      t.copilot.plugins.push = (r) => ni(r), Array.from(e).forEach((r) => {
        ai.includes(r) || (ni(r), ai.push(r));
      });
    }
  }), oe = [], Da && kt().setPublicPluginsState("INITIALIZED");
}
function kt() {
...
const mc = typeof crypto < "u" && crypto.randomUUID && crypto.randomUUID.bind(crypto), si = { randomUUID: mc };
function bc(t, e, r) {
  t = t || {};
...
function Ia(t, e, r) {
  return si.randomUUID && !t ? si.randomUUID() : bc(t);
}
...
class Kr extends qc {
  constructor(e) {
    if (super(e), this.it = S, e.type !== zc.CHILD) throw Error(this.constructor.directiveName + "() can only be used in child bindings");
  }
  render(e) {
...
const Lc = Rc(Kr), ve = window.Vaadin.copilot._machineState;
if (!ve)
...
function Uc(t) {
  La(t) || ve.addDismissedNotification(t);
}
function Zc(t) {
  return !(t.dismissId && (La(t.dismissId) || f.notifications.find((e) => e.dismissId === t.dismissId)));
}
function jc() {
  const t = "A server restart is required";
  return go() ? rr(le`${t} <br />${fo()}`) : rr(le`${t}`);
}
function fo() {
  return go() ? le`<vaadin-button
      theme="primary"
      @click=${(t) => {
    const e = t.target;
...
const Yd = (t, e) => t.error ? (Kc(t.error, e), !0) : !1, ci = (t, e, r) => {
  yr({
    type: Ze.ERROR,
    message: t,
    details: rr(
  ...
  i && a ? Bc(
    ...
    e,
    r
  ) : ci(t, e), Hc() && (o?.templateData && typeof o.templateData == "string" && o.templateData.startsWith("data") && (o.templateData = "<IMAGE_DATA>"), y.emit("system-info-with-callback", {
...
${r}` : "")
  ...
  Dr(e) && e.suggestRestart && go() && (o.details = rr(le`${t}<br />${r} ${fo()}`), o.delay = 3e4), yr(o);
  let i;
...
function eu() {
  const t = Sr.jdkInfo;
  return !t || Ua() !== "success" ? "none" : t.jrebel ? "jrebel" : t.runningWitHotswap ? "hotswap" : "none";
}
function od() {
...
class ad {
  ...
  async includeFlowNode(e) {
    if (fl(e) || zt(e)?.hiddenByServer)
      return !1;
    const r = zt(e);
    return r && this.nodeUuidNodeMapFlat.has(pi(r)) ? !1 : this.isInitializedInProjectSources(e);
  }
  ...
  async addToTree(e, r) {
    ...
    const n = a ?? r, s = i ? Array.from(e.children) : sl(e);
    for (const l of s)
      await this.addToTree(l, n);
    return a !== void 0;
  }
  generateNodeFromFiber(e, r) {
    const o = Lo(e) ? tr(e) : void 0, i = r?.children.length ?? 0, a = this;
    return {
      node: e,
      parent: r,
      element: o,
      ...
      get nameAndIdentifier() {
        return vi(this.name, this.identifier);
      },
      get previousSibling() {
        if (i !== 0)
...
async function Mt() {
  return (await import("./copilot-focus-trap-aC1ojjtA.js")).copilotFocusTrap;
}
async function Za() {
  return (await Promise.resolve().then(() => pc)).copilotOverlayManager;
}
function dd() {
  return import("./typescript-taXVvOW9.js").then((t) => t.t);
}
const ja = {
  edit: {
    label: "Edit",
    ...
    onActivation: async () => {
      const t = await Mt();
      t.active || t.activate(), await fi(), Nr();
    }
  },
  test: {
    label: "Test",
    ...
    onActivation: async (t) => {
      (t === "edit" || t === "inspect") && ((await Mt()).deactivate(), await gi()), Nr();
    }
  },
  inspect: {
    label: "Inspect",
  ...
  play: {
    ...
    default: !0,
    onActivation: async (t) => {
      (t === "edit" || t === "inspect") && ((await Mt()).deactivate(), await gi());
    }
  }
};
async function fi() {
...
const Qr = (t) => {
  if (ve.isActivationShortcut() && ve.getToolbarExpandMode() !== "never")
    if (t.key === "Shift" && !t.ctrlKey && !t.altKey && !t.metaKey)
      bi = !0;
    else if (bi && t.shiftKey && (t.key === "Control" || t.key === "Meta")) {
      if (dt++, dt === 2)
...
const wi = (t) => {
  ...
  if (!e)
    return;
  const r = ud(e), o = e.localName === "copilot-main", i = or(e, "copilot-outline-panel") !== null, a = or(e, "copilot-toolbar") !== null;
  ...
  } else hd(t) && f.activeMode === "edit" ? (y.emit("delete-selected", {}), s = !0) : (t.ctrlKey || t.metaKey) && t.key === "d" && f.activeMode === "edit" ? (y.emit("duplicate-selected", {}), s = !0) : (t.ctrlKey || t.metaKey) && t.key === "b" ? (y.emit("show-selected-in-ide", { attach: t.shiftKey }), s = !0) : (t.ctrlKey || t.metaKey) && t.key === "z" && pd() ? (y.emit("undoRedo", { undo: !t.shiftKey }), s = !0) : yi(t) || y.emit("keyboard-event", { event: t });
...
}, fd = async () => br(`${ot}get-user-info`, {}, (t) => (delete t.data.reqId, t.data));
 ...
 */
const zr = (t) => t ?? S;
var gd = Object.defineProperty, md = Object.getOwnPropertyDescriptor, me = (t, e, r, o) => {
  for (var i = o > 1 ? void 0 : o ? md(e, r) : e, a = t.length - 1, n; a >= 0; a--)
    (n = t[a]) && (i = (o ? n(e, r, i) : n(i)) || i);
  return o && i && gd(e, r, i), i;
};
let ce = class extends Be {
  constructor() {
    super(...arguments), this.ariaLabel = "", this.ariaLabelledby = "", this.ariaDescribedby = "", this.description = "", this.checked = !1, this.disabled = !1, this.documentMouseDownEventClickListener = (t) => {
      const e = ba([this]);
      ga(e, t.x, t.y) || (this.buttonElement.blur(), document.removeEventListener("mousedown", this.documentMouseDownEventClickListener, { capture: !0 }));
    };
  }
  createRenderRoot() {
    return this;
  ...
  render() {
    return le`
      <button
        aria-label="${zr(this.ariaLabel || void 0)}"
        aria-labelledby="${zr(this.ariaLabelledby || void 0)}"
        aria-describedby="${zr(this.ariaDescribedby || void 0)}"
...
ce = me([
  Oa("copilot-toggle-button")
], ce);
var bd = Object.defineProperty, yd = Object.getOwnPropertyDescriptor, mo = (t, e, r, o) => {
  for (var i = o > 1 ? void 0 : o ? yd(e, r) : e, a = t.length - 1, n; a >= 0; a--)
    (n = t[a]) && (i = (o ? n(e, r, i) : n(i)) || i);
  return o && i && bd(e, r, i), i;
};
let nr = class extends cc {
  ...
  async init() {
    if (this.initialized)
      return;
    await window.Vaadin.copilot._machineState.initializer.promise, await import("./copilot-global-vars-later-2jQwbiWP.js"), await import("./copilot-init-step2-DUdxIq9B.js"), hc(), this.tabIndex = 0, window.addEventListener("keydown", Qr), this.addEventListener("keydown", wi), y.onSend(this.handleSendEvent), this.removers.push(
      ...
      async (e, r) => {
        ...
        Oe.restorePanelsFromStorage(), (e !== "play" || Array.from(Oe.getOpenPanelTags()).some((o) => Fs(o))) && (Wa(), dc(), uc(), await nd()), this.ensureTopmostPopover();
      },
      { fireImmediately: !0 }
    ), this.reaction(
      () => ve.getSelectedTheme(),
    ...
    t.observe(this), this.removers.push(() => {
      t.disconnect();
    }), Qc(), this.detectAppTheme(), this.initialized = !0, id();
  }
  disconnectedCallback() {
    super.disconnectedCallback(), window.removeEventListener("keydown", Qr), this.removeEventListener("keydown", wi), y.offSend(this.handleSendEvent), this.removers.forEach((t) => t()), this.removeEventListener("dragover", this.dragOverListener), this.removeEventListener("dragleave", this.dragLeaveListener), this.removeEventListener("drop", this.dropListener), Jr.removeOverlayOutsideClickEvent(), document.documentElement.removeEventListener("vaadin-overlay-outside-click", this.overlayOutsideClickListener), document.body.removeEventListener("vaadin-overlay-open", this.overlayListener);
  }
  handleSendEvent(t) {
  ...
  detectAppTheme() {
    Mo("lumo") ? f.setAppTheme("lumo") : Mo("aura") ? f.setAppTheme("aura") : f.setAppTheme(null), br(`${ot}set-app-theme`, { theme: f.appTheme }, () => {
    });
  }
...
function au(t, e, r) {
  return Xa(t, r).map((o) => Sd(o, e)).filter((o) => o !== void 0);
}
export {
  ve as $,
  Cd as A,
